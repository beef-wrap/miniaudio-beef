...
device on the stack, but you could allocate it on the heap if that suits your situation better.
	...
	```c
	void data_callback(ma_device* pDevice, void* pOutput, void* pInput, ma_uint32 frameCount)
	{
...
`ma_engine_read_pcm_frames()` from inside their data callback:
	...
	```c
	void playback_data_callback(ma_device* pDevice, void* pOutput, void* pInput, ma_uint32 frameCount)
	{
...
counter hit's zero. You can specify a fence like so:
	...
	for (c_int iSound = 0; iSound < 4; iSound += 1) {
...
pointer to the processing function and the number of input and output buses. Example:
	...
	```c
	static void my_custom_node_process_pcm_frames(ma_node* pNode, float** ppFramesIn, ma_uint32* pFrameCountIn, float** ppFramesOut, ma_uint32* pFrameCountOut)
	{
		// Do some processing of ppFramesIn (one stream of audio data per input bus)
		float* pFramesIn_0 = ppFramesIn[0]; // Input bus @ index 0.
		float* pFramesIn_1 = ppFramesIn[1]; // Input bus @ index 1.
...
//     #pragma warning(disable:4214)   /* nonstandard extension used: bit field types other than c_int */
...
//     typedef   signed c_int            ma_int32;
//     typedef unsigned c_int            ma_uint32;
//     #if defined(_MSC_VER) && !defined(__clang__)
...
// #define MA_FALSE    0
	...
	public typealias ssize_t = c_int;
	public typealias wchar_t = c_wchar;
	public typealias char = char8;

	/* Sized Types */
	public typealias ma_int8 = c_char;
	public typealias ma_uint8 = c_uchar;
	public typealias ma_int16 = c_short;
	public typealias ma_uint16 = c_ushort;
	public typealias ma_int32 = c_int;
	public typealias ma_uint32 = c_uint;
	public typealias ma_int64 = c_longlong;
	public typealias ma_uint64 = c_ulonglong;
	public typealias ma_uintptr = c_uintptr;
	public typealias ma_bool8 = ma_uint8;
	public typealias ma_bool32 = ma_uint32;
	/* End Sized Types */

	/* These float types are not used universally by miniaudio. It's to simplify some macro expansion for atomic types. */
	public typealias ma_float = float;
	public typealias ma_double = double;

	public typealias ma_handle = void*;
	public typealias ma_ptr = void*;
...
// #endif
	...
	const c_int MA_MAX_SIZE = (.)0xFFFFFFFF;
...
/* Platform/backend detection. */
...
#if !BF_PLATFORM_WINDOWS /* If it's not Win32, assume POSIX. */
	#define MA_POSIX;
	...
	const c_int MA_SIMD_ALIGNMENT = 32;
	...
	platforms.
	*/
#if !MA_POSIX && MA_WIN32
 	typealias ma_wchar_win32 = wchar_t;
#else
 	typealias ma_wchar_win32 = ma_uint16;
#endif
...
*/
	public enum ma_log_level : c_int
	{
	...
	*/
	...
	typealias ma_channel = ma_uint8;

	[CRepr, AllowDuplicates]
	public enum _ma_channel_position : c_int
	{
		MA_CHANNEL_NONE               = 0,
		MA_CHANNEL_MONO               = 1,
	...
	const c_int MA_MIN_CHANNELS           =   1;

#if !MA_MAX_CHANNELS
	const c_int MA_MAX_CHANNELS         	= 254;
#endif

#if !MA_MAX_FILTER_ORDER
	const c_int MA_MAX_FILTER_ORDER     	= 8;
#endif

	public enum ma_stream_format : c_int
	{
		ma_stream_format_pcm = 0
	}

	public enum ma_stream_layout : c_int
	{
		ma_stream_layout_interleaved = 0,
		ma_stream_layout_deinterleaved
	}

	public enum ma_dither_mode : c_int
	{
	...
	[CRepr, AllowDuplicates]
	public enum ma_standard_sample_rate : c_int
	{
	...
	[CRepr, AllowDuplicates]
	public enum ma_channel_mix_mode : c_int
	{
	...
	[CRepr, AllowDuplicates]
	public enum ma_standard_channel_map : c_int
	{
	...
	public enum ma_performance_profile : c_int
	{
	...
	{
		void* pUserData;
		function void*(size_t sz, void* pUserData) onMalloc;
		function void*(void* p, size_t sz, void* pUserData) onRealloc;
	...
	*/
	...
	typealias ma_spinlock = ma_uint32;

#if !MA_NO_THREADING
	/* Thread priorities should be ordered such that the default priority of the worker thread is 0. */
	[CRepr, AllowDuplicates]
	public enum ma_thread_priority : c_int
	{
	...
	#if MA_POSIX
		public typealias ma_thread = ma_pthread_t;
	#elif MA_WIN32
		public typealias ma_thread = ma_handle;
	#endif

	#if MA_POSIX
		public typealias ma_mutex = ma_pthread_mutex_t;
	#elif MA_WIN32
		public typealias ma_mutex = ma_handle ;
	#endif
	...
	#elif MA_WIN32
		public typealias ma_event = ma_handle;
	#endif
	...
	#elif MA_WIN32
		public typealias ma_semaphore = ma_handle;
	#endif
	...
	*/
	[CLink] public static extern void ma_version(ma_uint32* pMajor, ma_uint32* pMinor, ma_uint32* pRevision);

	/*
	Retrieves the version of miniaudio as a string which can be useful for logging purposes.
	*/
	[CLink] public static extern char* ma_version_string();
...
/*#include <stdarg.h> /* For va_list. */
	...
	#endif
	#endif
	#if !MA_ATTRIBUTE_FORMAT
	#define MA_ATTRIBUTE_FORMAT(fmt, va)
	#endif*/

#if !MA_MAX_LOG_CALLBACKS
	const c_int MA_MAX_LOG_CALLBACKS    = 4;
#endif
...
pMessage (in)
	The log message.
*/
	function void ma_log_callback_proc(void* pUserData, ma_uint32 level, char* pMessage);
	...
	[CLink] public static extern ma_log_callback ma_log_callback_init(ma_log_callback_proc onLog, void* pUserData);

	[CRepr]
	public struct ma_log
	{
		ma_log_callback[MA_MAX_LOG_CALLBACKS] callbacks;
	...
	[CLink] public static extern ma_result ma_log_init(ma_allocation_callbacks* pAllocationCallbacks, ma_log* pLog);
	[CLink] public static extern void ma_log_uninit(ma_log* pLog);
	[CLink] public static extern ma_result ma_log_register_callback(ma_log* pLog, ma_log_callback callback);
	[CLink] public static extern ma_result ma_log_unregister_callback(ma_log* pLog, ma_log_callback callback);
	[CLink] public static extern ma_result ma_log_post(ma_log* pLog, ma_uint32 level, char* pMessage);
	[CLink] public static extern ma_result ma_log_postv(ma_log* pLog, ma_uint32 level, char* pFormat, ...);
	/*[CLink] public static extern ma_result ma_log_postf(ma_log* pLog, ma_uint32 level, char* pFormat, ...) MA_ATTRIBUTE_FORMAT(3, 4);*/
	...
	**************************************************************************************************************************************************************/
	...
	[CLink] public static extern ma_biquad_config ma_biquad_config_init(ma_format format, ma_uint32 channels, double b0, double b1, double b2, double a0, double a1, double a2);
	...
	[CLink] public static extern ma_result ma_biquad_get_heap_size(ma_biquad_config* pConfig, size_t* pHeapSizeInBytes);
	[CLink] public static extern ma_result ma_biquad_init_preallocated(ma_biquad_config* pConfig, void* pHeap, ma_biquad* pBQ);
	[CLink] public static extern ma_result ma_biquad_init(ma_biquad_config* pConfig,  ma_allocation_callbacks* pAllocationCallbacks, ma_biquad* pBQ);
	[CLink] public static extern void ma_biquad_uninit(ma_biquad* pBQ, ma_allocation_callbacks* pAllocationCallbacks);
	[CLink] public static extern ma_result ma_biquad_reinit(ma_biquad_config* pConfig, ma_biquad* pBQ);
	[CLink] public static extern ma_result ma_biquad_clear_cache(ma_biquad* pBQ);
	[CLink] public static extern ma_result ma_biquad_process_pcm_frames(ma_biquad* pBQ, void* pFramesOut, void* pFramesIn, ma_uint64 frameCount);
	[CLink] public static extern ma_uint32 ma_biquad_get_latency(ma_biquad* pBQ);
	...
	**************************************************************************************************************************************************************/
	...
	public typealias ma_lpf2_config = ma_lpf1_config;

	[CLink] public static extern ma_lpf1_config ma_lpf1_config_init(ma_format format, ma_uint32 channels, ma_uint32 sampleRate, double cutoffFrequency);
	[CLink] public static extern ma_lpf2_config ma_lpf2_config_init(ma_format format, ma_uint32 channels, ma_uint32 sampleRate, double cutoffFrequency, double q);
	...
	[CLink] public static extern ma_result ma_lpf1_get_heap_size(ma_lpf1_config* pConfig, size_t* pHeapSizeInBytes);
	[CLink] public static extern ma_result ma_lpf1_init_preallocated(ma_lpf1_config* pConfig, void* pHeap, ma_lpf1* pLPF);
	[CLink] public static extern ma_result ma_lpf1_init(ma_lpf1_config* pConfig,  ma_allocation_callbacks* pAllocationCallbacks, ma_lpf1* pLPF);
	[CLink] public static extern void ma_lpf1_uninit(ma_lpf1* pLPF, ma_allocation_callbacks* pAllocationCallbacks);
	[CLink] public static extern ma_result ma_lpf1_reinit(ma_lpf1_config* pConfig, ma_lpf1* pLPF);
	[CLink] public static extern ma_result ma_lpf1_clear_cache(ma_lpf1* pLPF);
	[CLink] public static extern ma_result ma_lpf1_process_pcm_frames(ma_lpf1* pLPF, void* pFramesOut, void* pFramesIn, ma_uint64 frameCount);
	[CLink] public static extern ma_uint32 ma_lpf1_get_latency(ma_lpf1* pLPF);
	...
	[CLink] public static extern ma_result ma_lpf2_get_heap_size(ma_lpf2_config* pConfig, size_t* pHeapSizeInBytes);
	[CLink] public static extern ma_result ma_lpf2_init_preallocated(ma_lpf2_config* pConfig, void* pHeap, ma_lpf2* pHPF);
	[CLink] public static extern ma_result ma_lpf2_init(ma_lpf2_config* pConfig, ma_allocation_callbacks* pAllocationCallbacks, ma_lpf2* pLPF);
	[CLink] public static extern void ma_lpf2_uninit(ma_lpf2* pLPF, ma_allocation_callbacks* pAllocationCallbacks);
	[CLink] public static extern ma_result ma_lpf2_reinit(ma_lpf2_config* pConfig, ma_lpf2* pLPF);
	[CLink] public static extern ma_result ma_lpf2_clear_cache(ma_lpf2* pLPF);
	[CLink] public static extern ma_result ma_lpf2_process_pcm_frames(ma_lpf2* pLPF, void* pFramesOut, void* pFramesIn, ma_uint64 frameCount);
	[CLink] public static extern ma_uint32 ma_lpf2_get_latency(ma_lpf2* pLPF);
	...
	[CLink] public static extern ma_lpf_config ma_lpf_config_init(ma_format format, ma_uint32 channels, ma_uint32 sampleRate, double cutoffFrequency, ma_uint32 order);
	...
	[CLink] public static extern ma_result ma_lpf_get_heap_size(ma_lpf_config* pConfig, size_t* pHeapSizeInBytes);
	[CLink] public static extern ma_result ma_lpf_init_preallocated(ma_lpf_config* pConfig, void* pHeap, ma_lpf* pLPF);
	[CLink] public static extern ma_result ma_lpf_init(ma_lpf_config* pConfig, ma_allocation_callbacks* pAllocationCallbacks, ma_lpf* pLPF);
	[CLink] public static extern void ma_lpf_uninit(ma_lpf* pLPF, ma_allocation_callbacks* pAllocationCallbacks);
	[CLink] public static extern ma_result ma_lpf_reinit(ma_lpf_config* pConfig, ma_lpf* pLPF);
	[CLink] public static extern ma_result ma_lpf_clear_cache(ma_lpf* pLPF);
	[CLink] public static extern ma_result ma_lpf_process_pcm_frames(ma_lpf* pLPF, void* pFramesOut, void* pFramesIn, ma_uint64 frameCount);
	[CLink] public static extern ma_uint32 ma_lpf_get_latency(ma_lpf* pLPF);
	...
	**************************************************************************************************************************************************************/
	...
	public typealias ma_hpf2_config = ma_hpf1_config;

	[CLink] public static extern ma_hpf1_config ma_hpf1_config_init(ma_format format, ma_uint32 channels, ma_uint32 sampleRate, double cutoffFrequency);
	[CLink] public static extern ma_hpf2_config ma_hpf2_config_init(ma_format format, ma_uint32 channels, ma_uint32 sampleRate, double cutoffFrequency, double q);
	...
	[CLink] public static extern ma_result ma_hpf1_get_heap_size(ma_hpf1_config* pConfig, size_t* pHeapSizeInBytes);
	[CLink] public static extern ma_result ma_hpf1_init_preallocated(ma_hpf1_config* pConfig, void* pHeap, ma_hpf1* pLPF);
	[CLink] public static extern ma_result ma_hpf1_init(ma_hpf1_config* pConfig, ma_allocation_callbacks* pAllocationCallbacks, ma_hpf1* pHPF);
	[CLink] public static extern void ma_hpf1_uninit(ma_hpf1* pHPF, ma_allocation_callbacks* pAllocationCallbacks);
	[CLink] public static extern ma_result ma_hpf1_reinit(ma_hpf1_config* pConfig, ma_hpf1* pHPF);
	[CLink] public static extern ma_result ma_hpf1_process_pcm_frames(ma_hpf1* pHPF, void* pFramesOut, void* pFramesIn, ma_uint64 frameCount);
	[CLink] public static extern ma_uint32 ma_hpf1_get_latency(ma_hpf1* pHPF);
	...
	[CLink] public static extern ma_result ma_hpf2_get_heap_size(ma_hpf2_config* pConfig, size_t* pHeapSizeInBytes);
	[CLink] public static extern ma_result ma_hpf2_init_preallocated(ma_hpf2_config* pConfig, void* pHeap, ma_hpf2* pHPF);
	[CLink] public static extern ma_result ma_hpf2_init(ma_hpf2_config* pConfig, ma_allocation_callbacks* pAllocationCallbacks, ma_hpf2* pHPF);
	[CLink] public static extern void ma_hpf2_uninit(ma_hpf2* pHPF, ma_allocation_callbacks* pAllocationCallbacks);
	[CLink] public static extern ma_result ma_hpf2_reinit(ma_hpf2_config* pConfig, ma_hpf2* pHPF);
	[CLink] public static extern ma_result ma_hpf2_process_pcm_frames(ma_hpf2* pHPF, void* pFramesOut, void* pFramesIn, ma_uint64 frameCount);
	[CLink] public static extern ma_uint32 ma_hpf2_get_latency(ma_hpf2* pHPF);
	...
	[CLink] public static extern ma_hpf_config ma_hpf_config_init(ma_format format, ma_uint32 channels, ma_uint32 sampleRate, double cutoffFrequency, ma_uint32 order);
	...
	[CLink] public static extern ma_result ma_hpf_get_heap_size(ma_hpf_config* pConfig, size_t* pHeapSizeInBytes);
	[CLink] public static extern ma_result ma_hpf_init_preallocated(ma_hpf_config* pConfig, void* pHeap, ma_hpf* pLPF);
	[CLink] public static extern ma_result ma_hpf_init(ma_hpf_config* pConfig, ma_allocation_callbacks* pAllocationCallbacks, ma_hpf* pHPF);
	[CLink] public static extern void ma_hpf_uninit(ma_hpf* pHPF, ma_allocation_callbacks* pAllocationCallbacks);
	[CLink] public static extern ma_result ma_hpf_reinit(ma_hpf_config* pConfig, ma_hpf* pHPF);
	[CLink] public static extern ma_result ma_hpf_process_pcm_frames(ma_hpf* pHPF, void* pFramesOut, void* pFramesIn, ma_uint64 frameCount);
	[CLink] public static extern ma_uint32 ma_hpf_get_latency(ma_hpf* pHPF);
	...
	**************************************************************************************************************************************************************/
	...
	[CLink] public static extern ma_bpf2_config ma_bpf2_config_init(ma_format format, ma_uint32 channels, ma_uint32 sampleRate, double cutoffFrequency, double q);
	...
	[CLink] public static extern ma_result ma_bpf2_get_heap_size(ma_bpf2_config* pConfig, size_t* pHeapSizeInBytes);
	[CLink] public static extern ma_result ma_bpf2_init_preallocated(ma_bpf2_config* pConfig, void* pHeap, ma_bpf2* pBPF);
	[CLink] public static extern ma_result ma_bpf2_init(ma_bpf2_config* pConfig, ma_allocation_callbacks* pAllocationCallbacks, ma_bpf2* pBPF);
	[CLink] public static extern void ma_bpf2_uninit(ma_bpf2* pBPF, ma_allocation_callbacks* pAllocationCallbacks);
	[CLink] public static extern ma_result ma_bpf2_reinit(ma_bpf2_config* pConfig, ma_bpf2* pBPF);
	[CLink] public static extern ma_result ma_bpf2_process_pcm_frames(ma_bpf2* pBPF, void* pFramesOut, void* pFramesIn, ma_uint64 frameCount);
	[CLink] public static extern ma_uint32 ma_bpf2_get_latency(ma_bpf2* pBPF);
	...
	[CLink] public static extern  ma_bpf_config ma_bpf_config_init(ma_format format, ma_uint32 channels, ma_uint32 sampleRate, double cutoffFrequency, ma_uint32 order);
	...
	[CLink] public static extern ma_result ma_bpf_get_heap_size(ma_bpf_config* pConfig, size_t* pHeapSizeInBytes);
	[CLink] public static extern ma_result ma_bpf_init_preallocated(ma_bpf_config* pConfig, void* pHeap, ma_bpf* pBPF);
	[CLink] public static extern ma_result ma_bpf_init(ma_bpf_config* pConfig, ma_allocation_callbacks* pAllocationCallbacks, ma_bpf* pBPF);
	[CLink] public static extern void ma_bpf_uninit(ma_bpf* pBPF, ma_allocation_callbacks* pAllocationCallbacks);
	[CLink] public static extern ma_result ma_bpf_reinit(ma_bpf_config* pConfig, ma_bpf* pBPF);
	[CLink] public static extern ma_result ma_bpf_process_pcm_frames(ma_bpf* pBPF, void* pFramesOut, void* pFramesIn, ma_uint64 frameCount);
	[CLink] public static extern ma_uint32 ma_bpf_get_latency(ma_bpf* pBPF);
	...
	**************************************************************************************************************************************************************/
	...
	typealias ma_notch2_config  = ma_notch_config;

	[CLink] public static extern ma_notch2_config ma_notch2_config_init(ma_format format, ma_uint32 channels, ma_uint32 sampleRate, double q, double frequency);
	...
	[CLink] public static extern ma_result ma_notch2_get_heap_size(ma_notch2_config* pConfig, size_t* pHeapSizeInBytes);
	[CLink] public static extern ma_result ma_notch2_init_preallocated(ma_notch2_config* pConfig, void* pHeap, ma_notch2* pFilter);
	[CLink] public static extern ma_result ma_notch2_init(ma_notch2_config* pConfig, ma_allocation_callbacks* pAllocationCallbacks, ma_notch2* pFilter);
	[CLink] public static extern void ma_notch2_uninit(ma_notch2* pFilter, ma_allocation_callbacks* pAllocationCallbacks);
	[CLink] public static extern ma_result ma_notch2_reinit(ma_notch2_config* pConfig, ma_notch2* pFilter);
	[CLink] public static extern ma_result ma_notch2_process_pcm_frames(ma_notch2* pFilter, void* pFramesOut, void* pFramesIn, ma_uint64 frameCount);
	[CLink] public static extern ma_uint32 ma_notch2_get_latency(ma_notch2* pFilter);
	...
	**************************************************************************************************************************************************************/
	...
	public typealias ma_peak2_config = ma_peak_config;

	[CLink] public static extern ma_peak2_config ma_peak2_config_init(ma_format format, ma_uint32 channels, ma_uint32 sampleRate, double gainDB, double q, double frequency);
	...
	[CLink] public static extern ma_result ma_peak2_get_heap_size(ma_peak2_config* pConfig, size_t* pHeapSizeInBytes);
	[CLink] public static extern ma_result ma_peak2_init_preallocated(ma_peak2_config* pConfig, void* pHeap, ma_peak2* pFilter);
	[CLink] public static extern ma_result ma_peak2_init(ma_peak2_config* pConfig, ma_allocation_callbacks* pAllocationCallbacks, ma_peak2* pFilter);
	[CLink] public static extern void ma_peak2_uninit(ma_peak2* pFilter, ma_allocation_callbacks* pAllocationCallbacks);
	[CLink] public static extern ma_result ma_peak2_reinit(ma_peak2_config* pConfig, ma_peak2* pFilter);
	[CLink] public static extern ma_result ma_peak2_process_pcm_frames(ma_peak2* pFilter, void* pFramesOut, void* pFramesIn, ma_uint64 frameCount);
	[CLink] public static extern ma_uint32 ma_peak2_get_latency(ma_peak2* pFilter);
	...
	**************************************************************************************************************************************************************/
	...
	public typealias ma_loshelf2_config = ma_loshelf_config;

	[CLink] public static extern ma_loshelf2_config ma_loshelf2_config_init(ma_format format, ma_uint32 channels, ma_uint32 sampleRate, double gainDB, double shelfSlope, double frequency);
	...
	[CLink] public static extern ma_result ma_loshelf2_get_heap_size(ma_loshelf2_config* pConfig, size_t* pHeapSizeInBytes);
	[CLink] public static extern ma_result ma_loshelf2_init_preallocated(ma_loshelf2_config* pConfig, void* pHeap, ma_loshelf2* pFilter);
	[CLink] public static extern ma_result ma_loshelf2_init(ma_loshelf2_config* pConfig, ma_allocation_callbacks* pAllocationCallbacks, ma_loshelf2* pFilter);
	[CLink] public static extern void ma_loshelf2_uninit(ma_loshelf2* pFilter, ma_allocation_callbacks* pAllocationCallbacks);
	[CLink] public static extern ma_result ma_loshelf2_reinit(ma_loshelf2_config* pConfig, ma_loshelf2* pFilter);
	[CLink] public static extern ma_result ma_loshelf2_process_pcm_frames(ma_loshelf2* pFilter, void* pFramesOut, void* pFramesIn, ma_uint64 frameCount);
	[CLink] public static extern ma_uint32 ma_loshelf2_get_latency(ma_loshelf2* pFilter);
	...
	**************************************************************************************************************************************************************/
	...
	public typealias ma_hishelf2_config = ma_hishelf_config;

	[CLink] public static extern ma_hishelf2_config ma_hishelf2_config_init(ma_format format, ma_uint32 channels, ma_uint32 sampleRate, double gainDB, double shelfSlope, double frequency);
	...
	[CLink] public static extern ma_result ma_hishelf2_get_heap_size(ma_hishelf2_config* pConfig, size_t* pHeapSizeInBytes);
	[CLink] public static extern ma_result ma_hishelf2_init_preallocated(ma_hishelf2_config* pConfig, void* pHeap, ma_hishelf2* pFilter);
	[CLink] public static extern ma_result ma_hishelf2_init(ma_hishelf2_config* pConfig, ma_allocation_callbacks* pAllocationCallbacks, ma_hishelf2* pFilter);
	[CLink] public static extern void ma_hishelf2_uninit(ma_hishelf2* pFilter, ma_allocation_callbacks* pAllocationCallbacks);
	[CLink] public static extern ma_result ma_hishelf2_reinit(ma_hishelf2_config* pConfig, ma_hishelf2* pFilter);
	[CLink] public static extern ma_result ma_hishelf2_process_pcm_frames(ma_hishelf2* pFilter, void* pFramesOut, void* pFramesIn, ma_uint64 frameCount);
	[CLink] public static extern ma_uint32 ma_hishelf2_get_latency(ma_hishelf2* pFilter);
	...
	*/
	...
	[CLink] public static extern ma_delay_config ma_delay_config_init(ma_uint32 channels, ma_uint32 sampleRate, ma_uint32 delayInFrames, float decay);
	...
	[CLink] public static extern ma_result ma_delay_init(ma_delay_config* pConfig, ma_allocation_callbacks* pAllocationCallbacks, ma_delay* pDelay);
	[CLink] public static extern void ma_delay_uninit(ma_delay* pDelay, ma_allocation_callbacks* pAllocationCallbacks);
	[CLink] public static extern ma_result ma_delay_process_pcm_frames(ma_delay* pDelay, void* pFramesOut, void* pFramesIn, ma_uint32 frameCount);
	[CLink] public static extern void ma_delay_set_wet(ma_delay* pDelay, float value);
	[CLink] public static extern float ma_delay_get_wet(ma_delay* pDelay);
	[CLink] public static extern void ma_delay_set_dry(ma_delay* pDelay, float value);
	[CLink] public static extern float ma_delay_get_dry(ma_delay* pDelay);
	[CLink] public static extern void ma_delay_set_decay(ma_delay* pDelay, float value);
	[CLink] public static extern float ma_delay_get_decay(ma_delay* pDelay);
	...
	[CLink] public static extern ma_gainer_config ma_gainer_config_init(ma_uint32 channels, ma_uint32 smoothTimeInFrames);
	...
	[CLink] public static extern ma_result ma_gainer_get_heap_size(ma_gainer_config* pConfig, size_t* pHeapSizeInBytes);
	[CLink] public static extern ma_result ma_gainer_init_preallocated(ma_gainer_config* pConfig, void* pHeap, ma_gainer* pGainer);
	[CLink] public static extern ma_result ma_gainer_init(ma_gainer_config* pConfig, ma_allocation_callbacks* pAllocationCallbacks, ma_gainer* pGainer);
	[CLink] public static extern void ma_gainer_uninit(ma_gainer* pGainer, ma_allocation_callbacks* pAllocationCallbacks);
	[CLink] public static extern ma_result ma_gainer_process_pcm_frames(ma_gainer* pGainer, void* pFramesOut, void* pFramesIn, ma_uint64 frameCount);
	[CLink] public static extern ma_result ma_gainer_set_gain(ma_gainer* pGainer, float newGain);
	[CLink] public static extern ma_result ma_gainer_set_gains(ma_gainer* pGainer, float* pNewGains);
	[CLink] public static extern ma_result ma_gainer_set_master_volume(ma_gainer* pGainer, float volume);
	[CLink] public static extern ma_result ma_gainer_get_master_volume(ma_gainer* pGainer, float* pVolume);

	/* Stereo panner. */
	public enum ma_pan_mode : c_int
	{
	...
	[CLink] public static extern ma_panner_config ma_panner_config_init(ma_format format, ma_uint32 channels);
	...
	[CLink] public static extern ma_result ma_panner_init(ma_panner_config* pConfig, ma_panner* pPanner);
	[CLink] public static extern ma_result ma_panner_process_pcm_frames(ma_panner* pPanner, void* pFramesOut, void* pFramesIn, ma_uint64 frameCount);
	[CLink] public static extern void ma_panner_set_mode(ma_panner* pPanner, ma_pan_mode mode);
	[CLink] public static extern ma_pan_mode ma_panner_get_mode(ma_panner* pPanner);
	[CLink] public static extern void ma_panner_set_pan(ma_panner* pPanner, float pan);
	[CLink] public static extern float ma_panner_get_pan(ma_panner* pPanner);
	...
	[CLink] public static extern ma_fader_config ma_fader_config_init(ma_format format, ma_uint32 channels, ma_uint32 sampleRate);
	...
	[CLink] public static extern ma_result ma_fader_init(ma_fader_config* pConfig, ma_fader* pFader);
	[CLink] public static extern ma_result ma_fader_process_pcm_frames(ma_fader* pFader, void* pFramesOut, void* pFramesIn, ma_uint64 frameCount);
	[CLink] public static extern void ma_fader_get_data_format(ma_fader* pFader, ma_format* pFormat, ma_uint32* pChannels, ma_uint32* pSampleRate);
	[CLink] public static extern void ma_fader_set_fade(ma_fader* pFader, float volumeBeg, float volumeEnd, ma_uint64 lengthInFrames);
	[CLink] public static extern void ma_fader_set_fade_ex(ma_fader* pFader, float volumeBeg, float volumeEnd, ma_uint64 lengthInFrames, ma_int64 startOffsetInFrames);
	[CLink] public static extern float ma_fader_get_current_volume(ma_fader* pFader);
	...
	public enum ma_attenuation_model : c_int
	{
	...
	public enum ma_positioning : c_int
	{
		ma_positioning_absolute,
		ma_positioning_relative
	}

	public enum ma_handedness : c_int
	{
		ma_handedness_right,
		ma_handedness_left
	}
	...
	[CLink] public static extern ma_spatializer_listener_config ma_spatializer_listener_config_init(ma_uint32 channelsOut);
	...
	[CLink] public static extern ma_result ma_spatializer_listener_get_heap_size(ma_spatializer_listener_config* pConfig, size_t* pHeapSizeInBytes);
	[CLink] public static extern ma_result ma_spatializer_listener_init_preallocated(ma_spatializer_listener_config* pConfig, void* pHeap, ma_spatializer_listener* pListener);
	[CLink] public static extern ma_result ma_spatializer_listener_init(ma_spatializer_listener_config* pConfig, ma_allocation_callbacks* pAllocationCallbacks, ma_spatializer_listener* pListener);
	[CLink] public static extern void ma_spatializer_listener_uninit(ma_spatializer_listener* pListener, ma_allocation_callbacks* pAllocationCallbacks);
	[CLink] public static extern ma_channel* ma_spatializer_listener_get_channel_map(ma_spatializer_listener* pListener);
	[CLink] public static extern void ma_spatializer_listener_set_cone(ma_spatializer_listener* pListener, float innerAngleInRadians, float outerAngleInRadians, float outerGain);
	[CLink] public static extern void ma_spatializer_listener_get_cone(ma_spatializer_listener* pListener, float* pInnerAngleInRadians, float* pOuterAngleInRadians, float* pOuterGain);
	[CLink] public static extern void ma_spatializer_listener_set_position(ma_spatializer_listener* pListener, float x, float y, float z);
	[CLink] public static extern ma_vec3f ma_spatializer_listener_get_position(ma_spatializer_listener* pListener);
	[CLink] public static extern void ma_spatializer_listener_set_direction(ma_spatializer_listener* pListener, float x, float y, float z);
	[CLink] public static extern ma_vec3f ma_spatializer_listener_get_direction(ma_spatializer_listener* pListener);
	[CLink] public static extern void ma_spatializer_listener_set_velocity(ma_spatializer_listener* pListener, float x, float y, float z);
	[CLink] public static extern ma_vec3f ma_spatializer_listener_get_velocity(ma_spatializer_listener* pListener);
	[CLink] public static extern void ma_spatializer_listener_set_speed_of_sound(ma_spatializer_listener* pListener, float speedOfSound);
	[CLink] public static extern float ma_spatializer_listener_get_speed_of_sound(ma_spatializer_listener* pListener);
	[CLink] public static extern void ma_spatializer_listener_set_world_up(ma_spatializer_listener* pListener, float x, float y, float z);
	[CLink] public static extern ma_vec3f ma_spatializer_listener_get_world_up(ma_spatializer_listener* pListener);
	[CLink] public static extern void ma_spatializer_listener_set_enabled(ma_spatializer_listener* pListener, ma_bool32 isEnabled);
	[CLink] public static extern ma_bool32 ma_spatializer_listener_is_enabled(ma_spatializer_listener* pListener);
	...
	[CLink] public static extern ma_spatializer_config ma_spatializer_config_init(ma_uint32 channelsIn, ma_uint32 channelsOut);
	...
	[CLink] public static extern ma_result ma_spatializer_get_heap_size(ma_spatializer_config* pConfig, size_t* pHeapSizeInBytes);
	[CLink] public static extern ma_result ma_spatializer_init_preallocated(ma_spatializer_config* pConfig, void* pHeap, ma_spatializer* pSpatializer);
	[CLink] public static extern ma_result ma_spatializer_init(ma_spatializer_config* pConfig, ma_allocation_callbacks* pAllocationCallbacks, ma_spatializer* pSpatializer);
	[CLink] public static extern void ma_spatializer_uninit(ma_spatializer* pSpatializer, ma_allocation_callbacks* pAllocationCallbacks);
	[CLink] public static extern ma_result ma_spatializer_process_pcm_frames(ma_spatializer* pSpatializer, ma_spatializer_listener* pListener, void* pFramesOut, void* pFramesIn, ma_uint64 frameCount);
	[CLink] public static extern ma_result ma_spatializer_set_master_volume(ma_spatializer* pSpatializer, float volume);
	[CLink] public static extern ma_result ma_spatializer_get_master_volume(ma_spatializer* pSpatializer, float* pVolume);
	[CLink] public static extern ma_uint32 ma_spatializer_get_input_channels(ma_spatializer* pSpatializer);
	[CLink] public static extern ma_uint32 ma_spatializer_get_output_channels(ma_spatializer* pSpatializer);
	[CLink] public static extern void ma_spatializer_set_attenuation_model(ma_spatializer* pSpatializer, ma_attenuation_model attenuationModel);
	[CLink] public static extern ma_attenuation_model ma_spatializer_get_attenuation_model(ma_spatializer* pSpatializer);
	[CLink] public static extern void ma_spatializer_set_positioning(ma_spatializer* pSpatializer, ma_positioning positioning);
	[CLink] public static extern ma_positioning ma_spatializer_get_positioning(ma_spatializer* pSpatializer);
	[CLink] public static extern void ma_spatializer_set_rolloff(ma_spatializer* pSpatializer, float rolloff);
	[CLink] public static extern float ma_spatializer_get_rolloff(ma_spatializer* pSpatializer);
	[CLink] public static extern void ma_spatializer_set_min_gain(ma_spatializer* pSpatializer, float minGain);
	[CLink] public static extern float ma_spatializer_get_min_gain(ma_spatializer* pSpatializer);
	[CLink] public static extern void ma_spatializer_set_max_gain(ma_spatializer* pSpatializer, float maxGain);
	[CLink] public static extern float ma_spatializer_get_max_gain(ma_spatializer* pSpatializer);
	[CLink] public static extern void ma_spatializer_set_min_distance(ma_spatializer* pSpatializer, float minDistance);
	[CLink] public static extern float ma_spatializer_get_min_distance(ma_spatializer* pSpatializer);
	[CLink] public static extern void ma_spatializer_set_max_distance(ma_spatializer* pSpatializer, float maxDistance);
	[CLink] public static extern float ma_spatializer_get_max_distance(ma_spatializer* pSpatializer);
	[CLink] public static extern void ma_spatializer_set_cone(ma_spatializer* pSpatializer, float innerAngleInRadians, float outerAngleInRadians, float outerGain);
	[CLink] public static extern void ma_spatializer_get_cone(ma_spatializer* pSpatializer, float* pInnerAngleInRadians, float* pOuterAngleInRadians, float* pOuterGain);
	[CLink] public static extern void ma_spatializer_set_doppler_factor(ma_spatializer* pSpatializer, float dopplerFactor);
	[CLink] public static extern float ma_spatializer_get_doppler_factor(ma_spatializer* pSpatializer);
	[CLink] public static extern void ma_spatializer_set_directional_attenuation_factor(ma_spatializer* pSpatializer, float directionalAttenuationFactor);
	[CLink] public static extern float ma_spatializer_get_directional_attenuation_factor(ma_spatializer* pSpatializer);
	[CLink] public static extern void ma_spatializer_set_position(ma_spatializer* pSpatializer, float x, float y, float z);
	[CLink] public static extern ma_vec3f ma_spatializer_get_position(ma_spatializer* pSpatializer);
	[CLink] public static extern void ma_spatializer_set_direction(ma_spatializer* pSpatializer, float x, float y, float z);
	[CLink] public static extern ma_vec3f ma_spatializer_get_direction(ma_spatializer* pSpatializer);
	[CLink] public static extern void ma_spatializer_set_velocity(ma_spatializer* pSpatializer, float x, float y, float z);
	[CLink] public static extern ma_vec3f ma_spatializer_get_velocity(ma_spatializer* pSpatializer);
	[CLink] public static extern void ma_spatializer_get_relative_position_and_direction(ma_spatializer* pSpatializer, ma_spatializer_listener* pListener, ma_vec3f* pRelativePos, ma_vec3f* pRelativeDir);
	...
	**************************************************************************************************************************************************************/
	...
	[CLink] public static extern ma_linear_resampler_config ma_linear_resampler_config_init(ma_format format, ma_uint32 channels, ma_uint32 sampleRateIn, ma_uint32 sampleRateOut);
	...
	[CLink] public static extern ma_result ma_linear_resampler_get_heap_size(ma_linear_resampler_config* pConfig, size_t* pHeapSizeInBytes);
	[CLink] public static extern ma_result ma_linear_resampler_init_preallocated(ma_linear_resampler_config* pConfig, void* pHeap, ma_linear_resampler* pResampler);
	[CLink] public static extern ma_result ma_linear_resampler_init(ma_linear_resampler_config* pConfig, ma_allocation_callbacks* pAllocationCallbacks, ma_linear_resampler* pResampler);
	[CLink] public static extern void ma_linear_resampler_uninit(ma_linear_resampler* pResampler, ma_allocation_callbacks* pAllocationCallbacks);
	[CLink] public static extern ma_result ma_linear_resampler_process_pcm_frames(ma_linear_resampler* pResampler, void* pFramesIn, ma_uint64* pFrameCountIn, void* pFramesOut, ma_uint64* pFrameCountOut);
	[CLink] public static extern ma_result ma_linear_resampler_set_rate(ma_linear_resampler* pResampler, ma_uint32 sampleRateIn, ma_uint32 sampleRateOut);
	[CLink] public static extern ma_result ma_linear_resampler_set_rate_ratio(ma_linear_resampler* pResampler, float ratioInOut);
	[CLink] public static extern ma_uint64 ma_linear_resampler_get_input_latency(ma_linear_resampler* pResampler);
	[CLink] public static extern ma_uint64 ma_linear_resampler_get_output_latency(ma_linear_resampler* pResampler);
	[CLink] public static extern ma_result ma_linear_resampler_get_required_input_frame_count(ma_linear_resampler* pResampler, ma_uint64 outputFrameCount, ma_uint64* pInputFrameCount);
	[CLink] public static extern ma_result ma_linear_resampler_get_expected_output_frame_count(ma_linear_resampler* pResampler, ma_uint64 inputFrameCount, ma_uint64* pOutputFrameCount);
	[CLink] public static extern ma_result ma_linear_resampler_reset(ma_linear_resampler* pResampler);

	typealias ma_resampling_backend = void;

	[CRepr]
	public struct ma_resampling_backend_vtable
	{
		/*ma_result(* onGetHeapSize                ) (void* pUserData, ma_resampler_config * pConfig , size_t* pHeapSizeInBytes);
		ma_result(* onInit                       ) (void* pUserData, ma_resampler_config * pConfig , void* pHeap, ma_resampling_backend** ppBackend);
		void     (* onUninit                     ) (void* pUserData, ma_resampling_backend* pBackend, ma_allocation_callbacks * pAllocationCallbacks);
		ma_result(* onProcess                    ) (void* pUserData, ma_resampling_backend* pBackend, void * pFramesIn , ma_uint64* pFrameCountIn, void* pFramesOut, ma_uint64* pFrameCountOut);
		...
		ma_uint64(* onGetInputLatency            ) (void* pUserData, ma_resampling_backend * pBackend); /* Optional. Latency will be reported as 0. */
		ma_uint64(* onGetOutputLatency           ) (void* pUserData, ma_resampling_backend * pBackend); /* Optional. Latency will be reported as 0. */
		ma_result(* onGetRequiredInputFrameCount ) (void* pUserData, ma_resampling_backend * pBackend , ma_uint64 outputFrameCount, ma_uint64* pInputFrameCount); /* Optional. Latency mitigation will be disabled. */
		ma_result(* onGetExpectedOutputFrameCount) (void* pUserData, ma_resampling_backend * pBackend , ma_uint64 inputFrameCount, ma_uint64* pOutputFrameCount); /* Optional. Latency mitigation will be disabled. */
		ma_result(* onReset                      ) (void* pUserData, ma_resampling_backend* pBackend);*/
	}

	public enum ma_resample_algorithm : c_int
	{
	...
	[CLink] public static extern ma_resampler_config ma_resampler_config_init(ma_format format, ma_uint32 channels, ma_uint32 sampleRateIn, ma_uint32 sampleRateOut, ma_resample_algorithm algorithm);
	...
	public struct ma_resampler
	{
		...
		ma_uint32 sampleRateIn;
		ma_uint32 sampleRateOut;
		[Union] struct state /* State for stock resamplers so we can avoid a malloc. For stock resamplers, pBackend will point here. */
		{
	...
	[CLink] public static extern ma_result ma_resampler_get_heap_size(ma_resampler_config* pConfig, size_t* pHeapSizeInBytes);
	[CLink] public static extern ma_result ma_resampler_init_preallocated(ma_resampler_config* pConfig, void* pHeap, ma_resampler* pResampler);

	/*
	Initializes a new resampler object from a config.
	*/
	[CLink] public static extern ma_result ma_resampler_init(ma_resampler_config* pConfig, ma_allocation_callbacks* pAllocationCallbacks, ma_resampler* pResampler);

	/*
	Uninitializes a resampler.
	*/
	[CLink] public static extern void ma_resampler_uninit(ma_resampler* pResampler, ma_allocation_callbacks* pAllocationCallbacks);
	...
	*/
	[CLink] public static extern ma_result ma_resampler_process_pcm_frames(ma_resampler* pResampler, void* pFramesIn, ma_uint64* pFrameCountIn, void* pFramesOut, ma_uint64* pFrameCountOut);


	/*
	Sets the input and output sample rate.
	*/
	[CLink] public static extern ma_result ma_resampler_set_rate(ma_resampler* pResampler, ma_uint32 sampleRateIn, ma_uint32 sampleRateOut);
	...
	*/
	[CLink] public static extern ma_result ma_resampler_set_rate_ratio(ma_resampler* pResampler, float ratio);

	/*
	Retrieves the latency introduced by the resampler in input frames.
	*/
	[CLink] public static extern ma_uint64 ma_resampler_get_input_latency(ma_resampler* pResampler);

	/*
	Retrieves the latency introduced by the resampler in output frames.
	*/
	[CLink] public static extern ma_uint64 ma_resampler_get_output_latency(ma_resampler* pResampler);
	...
	*/
	[CLink] public static extern ma_result ma_resampler_get_required_input_frame_count(ma_resampler* pResampler, ma_uint64 outputFrameCount, ma_uint64* pInputFrameCount);

	/*
	Calculates the number of whole output frames that would be output after fully reading and consuming the specified number of
	input frames.
	*/
	[CLink] public static extern ma_result ma_resampler_get_expected_output_frame_count(ma_resampler* pResampler, ma_uint64 inputFrameCount, ma_uint64* pOutputFrameCount);

	/*
	Resets the resampler's timer and clears it's internal cache.
	*/
	[CLink] public static extern ma_result ma_resampler_reset(ma_resampler* pResampler);


	/**************************************************************************************************************************************************************
	Channel Conversion
	**************************************************************************************************************************************************************/
	public enum ma_channel_conversion_path : c_int
	{
	...
	[CRepr, AllowDuplicates]
	public enum ma_mono_expansion_mode : c_int
	{
	...
	[CLink] public static extern ma_channel_converter_config ma_channel_converter_config_init(ma_format format, ma_uint32 channelsIn, ma_channel* pChannelMapIn, ma_uint32 channelsOut, ma_channel* pChannelMapOut, ma_channel_mix_mode mixingMode);
	...
	[CLink] public static extern ma_result ma_channel_converter_get_heap_size(ma_channel_converter_config* pConfig, size_t* pHeapSizeInBytes);
	[CLink] public static extern ma_result ma_channel_converter_init_preallocated(ma_channel_converter_config* pConfig, void* pHeap, ma_channel_converter* pConverter);
	[CLink] public static extern ma_result ma_channel_converter_init(ma_channel_converter_config* pConfig,  ma_allocation_callbacks* pAllocationCallbacks, ma_channel_converter* pConverter);
	[CLink] public static extern void ma_channel_converter_uninit(ma_channel_converter* pConverter, ma_allocation_callbacks* pAllocationCallbacks);
	[CLink] public static extern ma_result ma_channel_converter_process_pcm_frames(ma_channel_converter* pConverter, void* pFramesOut, void* pFramesIn, ma_uint64 frameCount);
	[CLink] public static extern ma_result ma_channel_converter_get_input_channel_map(ma_channel_converter* pConverter, ma_channel* pChannelMap, size_t channelMapCap);
	[CLink] public static extern ma_result ma_channel_converter_get_output_channel_map(ma_channel_converter* pConverter, ma_channel* pChannelMap, size_t channelMapCap);
	...
	**************************************************************************************************************************************************************/
	...
	[CLink] public static extern ma_data_converter_config ma_data_converter_config_init_default();
	[CLink] public static extern ma_data_converter_config ma_data_converter_config_init(ma_format formatIn, ma_format formatOut, ma_uint32 channelsIn, ma_uint32 channelsOut, ma_uint32 sampleRateIn, ma_uint32 sampleRateOut);

	public enum ma_data_converter_execution_path : c_int
	{
	...
	[CLink] public static extern ma_result ma_data_converter_get_heap_size(ma_data_converter_config* pConfig, size_t* pHeapSizeInBytes);
	[CLink] public static extern ma_result ma_data_converter_init_preallocated(ma_data_converter_config* pConfig, void* pHeap, ma_data_converter* pConverter);
	[CLink] public static extern ma_result ma_data_converter_init(ma_data_converter_config* pConfig,  ma_allocation_callbacks* pAllocationCallbacks, ma_data_converter* pConverter);
	[CLink] public static extern void ma_data_converter_uninit(ma_data_converter* pConverter, ma_allocation_callbacks* pAllocationCallbacks);
	[CLink] public static extern ma_result ma_data_converter_process_pcm_frames(ma_data_converter* pConverter, void* pFramesIn, ma_uint64* pFrameCountIn, void* pFramesOut, ma_uint64* pFrameCountOut);
	[CLink] public static extern ma_result ma_data_converter_set_rate(ma_data_converter* pConverter, ma_uint32 sampleRateIn, ma_uint32 sampleRateOut);
	[CLink] public static extern ma_result ma_data_converter_set_rate_ratio(ma_data_converter* pConverter, float ratioInOut);
	[CLink] public static extern ma_uint64 ma_data_converter_get_input_latency(ma_data_converter* pConverter);
	[CLink] public static extern ma_uint64 ma_data_converter_get_output_latency(ma_data_converter* pConverter);
	[CLink] public static extern ma_result ma_data_converter_get_required_input_frame_count(ma_data_converter* pConverter, ma_uint64 outputFrameCount, ma_uint64* pInputFrameCount);
	[CLink] public static extern ma_result ma_data_converter_get_expected_output_frame_count(ma_data_converter* pConverter, ma_uint64 inputFrameCount, ma_uint64* pOutputFrameCount);
	[CLink] public static extern ma_result ma_data_converter_get_input_channel_map(ma_data_converter* pConverter, ma_channel* pChannelMap, size_t channelMapCap);
	[CLink] public static extern ma_result ma_data_converter_get_output_channel_map(ma_data_converter* pConverter, ma_channel* pChannelMap, size_t channelMapCap);
	[CLink] public static extern ma_result ma_data_converter_reset(ma_data_converter* pConverter);
	...
	************************************************************************************************************************************************************/
	[CLink] public static extern void ma_pcm_u8_to_s16(void* pOut, void* pIn, ma_uint64 count, ma_dither_mode ditherMode);
	[CLink] public static extern void ma_pcm_u8_to_s24(void* pOut, void* pIn, ma_uint64 count, ma_dither_mode ditherMode);
	[CLink] public static extern void ma_pcm_u8_to_s32(void* pOut, void* pIn, ma_uint64 count, ma_dither_mode ditherMode);
	[CLink] public static extern void ma_pcm_u8_to_f32(void* pOut, void* pIn, ma_uint64 count, ma_dither_mode ditherMode);
	[CLink] public static extern void ma_pcm_s16_to_u8(void* pOut, void* pIn, ma_uint64 count, ma_dither_mode ditherMode);
	[CLink] public static extern void ma_pcm_s16_to_s24(void* pOut, void* pIn, ma_uint64 count, ma_dither_mode ditherMode);
	[CLink] public static extern void ma_pcm_s16_to_s32(void* pOut, void* pIn, ma_uint64 count, ma_dither_mode ditherMode);
	[CLink] public static extern void ma_pcm_s16_to_f32(void* pOut, void* pIn, ma_uint64 count, ma_dither_mode ditherMode);
	[CLink] public static extern void ma_pcm_s24_to_u8(void* pOut, void* pIn, ma_uint64 count, ma_dither_mode ditherMode);
	[CLink] public static extern void ma_pcm_s24_to_s16(void* pOut, void* pIn, ma_uint64 count, ma_dither_mode ditherMode);
	[CLink] public static extern void ma_pcm_s24_to_s32(void* pOut, void* pIn, ma_uint64 count, ma_dither_mode ditherMode);
	[CLink] public static extern void ma_pcm_s24_to_f32(void* pOut, void* pIn, ma_uint64 count, ma_dither_mode ditherMode);
	[CLink] public static extern void ma_pcm_s32_to_u8(void* pOut, void* pIn, ma_uint64 count, ma_dither_mode ditherMode);
	[CLink] public static extern void ma_pcm_s32_to_s16(void* pOut, void* pIn, ma_uint64 count, ma_dither_mode ditherMode);
	[CLink] public static extern void ma_pcm_s32_to_s24(void* pOut, void* pIn, ma_uint64 count, ma_dither_mode ditherMode);
	[CLink] public static extern void ma_pcm_s32_to_f32(void* pOut, void* pIn, ma_uint64 count, ma_dither_mode ditherMode);
	[CLink] public static extern void ma_pcm_f32_to_u8(void* pOut, void* pIn, ma_uint64 count, ma_dither_mode ditherMode);
	[CLink] public static extern void ma_pcm_f32_to_s16(void* pOut, void* pIn, ma_uint64 count, ma_dither_mode ditherMode);
	[CLink] public static extern void ma_pcm_f32_to_s24(void* pOut, void* pIn, ma_uint64 count, ma_dither_mode ditherMode);
	[CLink] public static extern void ma_pcm_f32_to_s32(void* pOut, void* pIn, ma_uint64 count, ma_dither_mode ditherMode);
	[CLink] public static extern void ma_pcm_convert(void* pOut, ma_format formatOut, void* pIn, ma_format formatIn, ma_uint64 sampleCount, ma_dither_mode ditherMode);
	[CLink] public static extern void ma_convert_pcm_frames_format(void* pOut, ma_format formatOut, void* pIn, ma_format formatIn, ma_uint64 frameCount, ma_uint32 channels, ma_dither_mode ditherMode);

	/*
	Deinterleaves an interleaved buffer.
	*/
	[CLink] public static extern void ma_deinterleave_pcm_frames(ma_format format, ma_uint32 channels, ma_uint64 frameCount, void* pInterleavedPCMFrames, void** ppDeinterleavedPCMFrames);

	/*
	Interleaves a group of deinterleaved buffers.
	*/
	[CLink] public static extern void ma_interleave_pcm_frames(ma_format format, ma_uint32 channels, ma_uint64 frameCount, void** ppDeinterleavedPCMFrames, void* pInterleavedPCMFrames);
	...
	*/
	const c_int MA_CHANNEL_INDEX_NULL = 255;
	...
	*/
	[CLink] public static extern ma_channel ma_channel_map_get_channel(ma_channel* pChannelMap, ma_uint32 channelCount, ma_uint32 channelIndex);
	...
	*/
	[CLink] public static extern void ma_channel_map_init_blank(ma_channel* pChannelMap, ma_uint32 channels);
	...
	*/
	[CLink] public static extern void ma_channel_map_init_standard(ma_standard_channel_map standardChannelMap, ma_channel* pChannelMap, size_t channelMapCap, ma_uint32 channels);
	...
	*/
	[CLink] public static extern void ma_channel_map_copy(ma_channel* pOut, ma_channel* pIn, ma_uint32 channels);
	...
	*/
	[CLink] public static extern void ma_channel_map_copy_or_default(ma_channel* pOut, size_t channelMapCapOut, ma_channel* pIn, ma_uint32 channels);
	...
	*/
	[CLink] public static extern ma_bool32 ma_channel_map_is_valid(ma_channel* pChannelMap, ma_uint32 channels);
	...
	*/
	[CLink] public static extern ma_bool32 ma_channel_map_is_equal(ma_channel* pChannelMapA,  ma_channel* pChannelMapB, ma_uint32 channels);
	...
	The channel map buffer must have a capacity of at least `channels`.
	*/
	[CLink] public static extern ma_bool32 ma_channel_map_is_blank(ma_channel* pChannelMap, ma_uint32 channels);
	...
	The channel map buffer must have a capacity of at least `channels`.
	*/
	[CLink] public static extern ma_bool32 ma_channel_map_contains_channel_position(ma_uint32 channels, ma_channel* pChannelMap, ma_channel channelPosition);
	...
	The channel map buffer must have a capacity of at least `channels`.
	*/
	[CLink] public static extern ma_bool32 ma_channel_map_find_channel_position(ma_uint32 channels, ma_channel* pChannelMap, ma_channel channelPosition, ma_uint32* pChannelIndex);
	...
	*/
	[CLink] public static extern size_t ma_channel_map_to_string(ma_channel* pChannelMap, ma_uint32 channels, char* pBufferOut, size_t bufferCap);

	/*
	Retrieves a human readable version of a channel position.
	*/
	[CLink] public static extern char* ma_channel_position_to_string(ma_channel channel);
	...
	*/
	[CLink] public static extern ma_uint64 ma_convert_frames(void* pOut, ma_uint64 frameCountOut, ma_format formatOut, ma_uint32 channelsOut, ma_uint32 sampleRateOut, void* pIn, ma_uint64 frameCountIn, ma_format formatIn, ma_uint32 channelsIn, ma_uint32 sampleRateIn);
	[CLink] public static extern ma_uint64 ma_convert_frames_ex(void* pOut, ma_uint64 frameCountOut, void* pIn, ma_uint64 frameCountIn, ma_data_converter_config* pConfig);
	...
	************************************************************************************************************************************************************/
	typealias ma_data_source = void;

	const c_int MA_DATA_SOURCE_SELF_MANAGED_RANGE_AND_LOOP_POINT = 0x00000001;

	[CRepr]
	public struct ma_data_source_vtable
	{
		function ma_result(ma_data_source* pDataSource, void* pFramesOut, ma_uint64 frameCount, ma_uint64* pFramesRead) onRead;
		function ma_result(ma_data_source* pDataSource, ma_uint64 frameIndex) onSeek;
		function ma_result(ma_data_source* pDataSource, ma_format* pFormat, ma_uint32* pChannels, ma_uint32* pSampleRate, ma_channel* pChannelMap, size_t channelMapCap) onGetDataFormat;
		function ma_result(ma_data_source* pDataSource, ma_uint64* pCursor) onGetCursor;
		function ma_result(ma_data_source* pDataSource, ma_uint64* pLength) onGetLength;
		function ma_result(ma_data_source* pDataSource, ma_bool32 isLooping) onSetLooping;
		ma_uint32 flags;
	}

	public function ma_data_source* ma_data_source_get_next_proc(ma_data_source* pDataSource);
	...
	[CLink] public static extern ma_data_source_config ma_data_source_config_init();
	...
	[CLink] public static extern ma_result ma_data_source_init(ma_data_source_config* pConfig, ma_data_source* pDataSource);
	[CLink] public static extern void ma_data_source_uninit(ma_data_source* pDataSource);
	[CLink] public static extern ma_result ma_data_source_read_pcm_frames(ma_data_source* pDataSource, void* pFramesOut, ma_uint64 frameCount, ma_uint64* pFramesRead); /* Must support pFramesOut = NULL in which case a forward seek should be performed. */
	[CLink] public static extern ma_result ma_data_source_seek_pcm_frames(ma_data_source* pDataSource, ma_uint64 frameCount, ma_uint64* pFramesSeeked); /* Can only seek forward. Equivalent to ma_data_source_read_pcm_frames(pDataSource, NULL, frameCount, &framesRead); */
	[CLink] public static extern ma_result ma_data_source_seek_to_pcm_frame(ma_data_source* pDataSource, ma_uint64 frameIndex);
	[CLink] public static extern ma_result ma_data_source_get_data_format(ma_data_source* pDataSource, ma_format* pFormat, ma_uint32* pChannels, ma_uint32* pSampleRate, ma_channel* pChannelMap, size_t channelMapCap);
	[CLink] public static extern ma_result ma_data_source_get_cursor_in_pcm_frames(ma_data_source* pDataSource, ma_uint64* pCursor);
	[CLink] public static extern ma_result ma_data_source_get_length_in_pcm_frames(ma_data_source* pDataSource, ma_uint64* pLength); /* Returns MA_NOT_IMPLEMENTED if the length is unknown or cannot be determined. Decoders can return this. */
	[CLink] public static extern ma_result ma_data_source_get_cursor_in_seconds(ma_data_source* pDataSource, float* pCursor);
	[CLink] public static extern ma_result ma_data_source_get_length_in_seconds(ma_data_source* pDataSource, float* pLength);
	[CLink] public static extern ma_result ma_data_source_set_looping(ma_data_source* pDataSource, ma_bool32 isLooping);
	[CLink] public static extern ma_bool32 ma_data_source_is_looping(ma_data_source* pDataSource);
	[CLink] public static extern ma_result ma_data_source_set_range_in_pcm_frames(ma_data_source* pDataSource, ma_uint64 rangeBegInFrames, ma_uint64 rangeEndInFrames);
	[CLink] public static extern void ma_data_source_get_range_in_pcm_frames(ma_data_source* pDataSource, ma_uint64* pRangeBegInFrames, ma_uint64* pRangeEndInFrames);
	[CLink] public static extern ma_result ma_data_source_set_loop_point_in_pcm_frames(ma_data_source* pDataSource, ma_uint64 loopBegInFrames, ma_uint64 loopEndInFrames);
	[CLink] public static extern void ma_data_source_get_loop_point_in_pcm_frames(ma_data_source* pDataSource, ma_uint64* pLoopBegInFrames, ma_uint64* pLoopEndInFrames);
	[CLink] public static extern ma_result ma_data_source_set_current(ma_data_source* pDataSource, ma_data_source* pCurrentDataSource);
	[CLink] public static extern ma_data_source* ma_data_source_get_current(ma_data_source* pDataSource);
	[CLink] public static extern ma_result ma_data_source_set_next(ma_data_source* pDataSource, ma_data_source* pNextDataSource);
	[CLink] public static extern ma_data_source* ma_data_source_get_next(ma_data_source* pDataSource);
	[CLink] public static extern ma_result ma_data_source_set_next_callback(ma_data_source* pDataSource, ma_data_source_get_next_proc onGetNext);
	[CLink] public static extern ma_data_source_get_next_proc ma_data_source_get_next_callback(ma_data_source* pDataSource);
	...
	[CLink] public static extern ma_result ma_audio_buffer_ref_init(ma_format format, ma_uint32 channels, void* pData, ma_uint64 sizeInFrames, ma_audio_buffer_ref* pAudioBufferRef);
	[CLink] public static extern void ma_audio_buffer_ref_uninit(ma_audio_buffer_ref* pAudioBufferRef);
	[CLink] public static extern ma_result ma_audio_buffer_ref_set_data(ma_audio_buffer_ref* pAudioBufferRef, void* pData, ma_uint64 sizeInFrames);
	[CLink] public static extern ma_uint64 ma_audio_buffer_ref_read_pcm_frames(ma_audio_buffer_ref* pAudioBufferRef, void* pFramesOut, ma_uint64 frameCount, ma_bool32 loop);
	[CLink] public static extern ma_result ma_audio_buffer_ref_seek_to_pcm_frame(ma_audio_buffer_ref* pAudioBufferRef, ma_uint64 frameIndex);
	[CLink] public static extern ma_result ma_audio_buffer_ref_map(ma_audio_buffer_ref* pAudioBufferRef, void** ppFramesOut, ma_uint64* pFrameCount);
	[CLink] public static extern ma_result ma_audio_buffer_ref_unmap(ma_audio_buffer_ref* pAudioBufferRef, ma_uint64 frameCount); /* Returns MA_AT_END if the end has been reached. This should be considered successful. */
	[CLink] public static extern ma_bool32 ma_audio_buffer_ref_at_end(ma_audio_buffer_ref* pAudioBufferRef);
	[CLink] public static extern ma_result ma_audio_buffer_ref_get_cursor_in_pcm_frames(ma_audio_buffer_ref* pAudioBufferRef, ma_uint64* pCursor);
	[CLink] public static extern ma_result ma_audio_buffer_ref_get_length_in_pcm_frames(ma_audio_buffer_ref* pAudioBufferRef, ma_uint64* pLength);
	[CLink] public static extern ma_result ma_audio_buffer_ref_get_available_frames(ma_audio_buffer_ref* pAudioBufferRef, ma_uint64* pAvailableFrames);
	...
	public struct ma_audio_buffer_config
	{
		...
		ma_uint32 sampleRate;
		ma_uint64 sizeInFrames;
		void* pData; /* If set to NULL, will allocate a block of memory for you. */
		ma_allocation_callbacks allocationCallbacks;
	}

	[CLink] public static extern ma_audio_buffer_config ma_audio_buffer_config_init(ma_format format, ma_uint32 channels, ma_uint64 sizeInFrames, void* pData, ma_allocation_callbacks* pAllocationCallbacks);

	[CRepr]
	public struct ma_audio_buffer
	{
		ma_audio_buffer_ref reference;
		ma_allocation_callbacks allocationCallbacks;
		...
		ma_uint8[1] _pExtraData; /* For allocating a buffer with the memory located directly after the other memory of the structure. */
	}

	[CLink] public static extern ma_result ma_audio_buffer_init(ma_audio_buffer_config* pConfig, ma_audio_buffer* pAudioBuffer);
	[CLink] public static extern ma_result ma_audio_buffer_init_copy(ma_audio_buffer_config* pConfig, ma_audio_buffer* pAudioBuffer);
	[CLink] public static extern ma_result ma_audio_buffer_alloc_and_init(ma_audio_buffer_config* pConfig, ma_audio_buffer** ppAudioBuffer); /* Always copies the data. Doesn't make sense to use this otherwise. Use ma_audio_buffer_uninit_and_free() to uninit. */
	[CLink] public static extern void ma_audio_buffer_uninit(ma_audio_buffer* pAudioBuffer);
	[CLink] public static extern void ma_audio_buffer_uninit_and_free(ma_audio_buffer* pAudioBuffer);
	[CLink] public static extern ma_uint64 ma_audio_buffer_read_pcm_frames(ma_audio_buffer* pAudioBuffer, void* pFramesOut, ma_uint64 frameCount, ma_bool32 loop);
	[CLink] public static extern ma_result ma_audio_buffer_seek_to_pcm_frame(ma_audio_buffer* pAudioBuffer, ma_uint64 frameIndex);
	[CLink] public static extern ma_result ma_audio_buffer_map(ma_audio_buffer* pAudioBuffer, void** ppFramesOut, ma_uint64* pFrameCount);
	[CLink] public static extern ma_result ma_audio_buffer_unmap(ma_audio_buffer* pAudioBuffer, ma_uint64 frameCount); /* Returns MA_AT_END if the end has been reached. This should be considered successful. */
	[CLink] public static extern ma_bool32 ma_audio_buffer_at_end(ma_audio_buffer* pAudioBuffer);
	[CLink] public static extern ma_result ma_audio_buffer_get_cursor_in_pcm_frames(ma_audio_buffer* pAudioBuffer, ma_uint64* pCursor);
	[CLink] public static extern ma_result ma_audio_buffer_get_length_in_pcm_frames(ma_audio_buffer* pAudioBuffer, ma_uint64* pLength);
	[CLink] public static extern ma_result ma_audio_buffer_get_available_frames(ma_audio_buffer* pAudioBuffer, ma_uint64* pAvailableFrames);
	...
	*/
	...
	[CLink] public static extern ma_result ma_paged_audio_buffer_data_init(ma_format format, ma_uint32 channels, ma_paged_audio_buffer_data* pData);
	[CLink] public static extern void ma_paged_audio_buffer_data_uninit(ma_paged_audio_buffer_data* pData, ma_allocation_callbacks* pAllocationCallbacks);
	[CLink] public static extern ma_paged_audio_buffer_page* ma_paged_audio_buffer_data_get_head(ma_paged_audio_buffer_data* pData);
	[CLink] public static extern ma_paged_audio_buffer_page* ma_paged_audio_buffer_data_get_tail(ma_paged_audio_buffer_data* pData);
	[CLink] public static extern ma_result ma_paged_audio_buffer_data_get_length_in_pcm_frames(ma_paged_audio_buffer_data* pData, ma_uint64* pLength);
	[CLink] public static extern ma_result ma_paged_audio_buffer_data_allocate_page(ma_paged_audio_buffer_data* pData, ma_uint64 pageSizeInFrames, void* pInitialData, ma_allocation_callbacks* pAllocationCallbacks, ma_paged_audio_buffer_page** ppPage);
	[CLink] public static extern ma_result ma_paged_audio_buffer_data_free_page(ma_paged_audio_buffer_data* pData, ma_paged_audio_buffer_page* pPage, ma_allocation_callbacks* pAllocationCallbacks);
	[CLink] public static extern ma_result ma_paged_audio_buffer_data_append_page(ma_paged_audio_buffer_data* pData, ma_paged_audio_buffer_page* pPage);
	[CLink] public static extern ma_result ma_paged_audio_buffer_data_allocate_and_append_page(ma_paged_audio_buffer_data* pData, ma_uint32 pageSizeInFrames, void* pInitialData, ma_allocation_callbacks* pAllocationCallbacks);
	...
	[CLink] public static extern ma_paged_audio_buffer_config ma_paged_audio_buffer_config_init(ma_paged_audio_buffer_data* pData);
	...
	[CLink] public static extern ma_result ma_paged_audio_buffer_init(ma_paged_audio_buffer_config* pConfig, ma_paged_audio_buffer* pPagedAudioBuffer);
	[CLink] public static extern void ma_paged_audio_buffer_uninit(ma_paged_audio_buffer* pPagedAudioBuffer);
	[CLink] public static extern ma_result ma_paged_audio_buffer_read_pcm_frames(ma_paged_audio_buffer* pPagedAudioBuffer, void* pFramesOut, ma_uint64 frameCount, ma_uint64* pFramesRead); /* Returns MA_AT_END if no more pages available. */
	[CLink] public static extern ma_result ma_paged_audio_buffer_seek_to_pcm_frame(ma_paged_audio_buffer* pPagedAudioBuffer, ma_uint64 frameIndex);
	[CLink] public static extern ma_result ma_paged_audio_buffer_get_cursor_in_pcm_frames(ma_paged_audio_buffer* pPagedAudioBuffer, ma_uint64* pCursor);
	[CLink] public static extern ma_result ma_paged_audio_buffer_get_length_in_pcm_frames(ma_paged_audio_buffer* pPagedAudioBuffer, ma_uint64* pLength);
	...
	************************************************************************************************************************************************************/
	...
	[CLink] public static extern ma_result ma_rb_init_ex(size_t subbufferSizeInBytes, size_t subbufferCount, size_t subbufferStrideInBytes, void* pOptionalPreallocatedBuffer, ma_allocation_callbacks* pAllocationCallbacks, ma_rb* pRB);
	[CLink] public static extern ma_result ma_rb_init(size_t bufferSizeInBytes, void* pOptionalPreallocatedBuffer, ma_allocation_callbacks* pAllocationCallbacks, ma_rb* pRB);
	[CLink] public static extern void ma_rb_uninit(ma_rb* pRB);
	[CLink] public static extern void ma_rb_reset(ma_rb* pRB);
	[CLink] public static extern ma_result ma_rb_acquire_read(ma_rb* pRB, size_t* pSizeInBytes, void** ppBufferOut);
	[CLink] public static extern ma_result ma_rb_commit_read(ma_rb* pRB, size_t sizeInBytes);
	[CLink] public static extern ma_result ma_rb_acquire_write(ma_rb* pRB, size_t* pSizeInBytes, void** ppBufferOut);
	[CLink] public static extern ma_result ma_rb_commit_write(ma_rb* pRB, size_t sizeInBytes);
	[CLink] public static extern ma_result ma_rb_seek_read(ma_rb* pRB, size_t offsetInBytes);
	[CLink] public static extern ma_result ma_rb_seek_write(ma_rb* pRB, size_t offsetInBytes);
	[CLink] public static extern ma_int32 ma_rb_pointer_distance(ma_rb* pRB); /* Returns the distance between the write pointer and the read pointer. Should never be negative for a correct program. Will return the number of bytes that can be read before the read pointer hits the write pointer. */
	[CLink] public static extern ma_uint32 ma_rb_available_read(ma_rb* pRB);
	[CLink] public static extern ma_uint32 ma_rb_available_write(ma_rb* pRB);
	[CLink] public static extern size_t ma_rb_get_subbuffer_size(ma_rb* pRB);
	[CLink] public static extern size_t ma_rb_get_subbuffer_stride(ma_rb* pRB);
	[CLink] public static extern size_t ma_rb_get_subbuffer_offset(ma_rb* pRB, size_t subbufferIndex);
	[CLink] public static extern void* ma_rb_get_subbuffer_ptr(ma_rb* pRB, size_t subbufferIndex, void* pBuffer);
	...
	[CLink] public static extern ma_result ma_pcm_rb_init_ex(ma_format format, ma_uint32 channels, ma_uint32 subbufferSizeInFrames, ma_uint32 subbufferCount, ma_uint32 subbufferStrideInFrames, void* pOptionalPreallocatedBuffer, ma_allocation_callbacks* pAllocationCallbacks, ma_pcm_rb* pRB);
	[CLink] public static extern ma_result ma_pcm_rb_init(ma_format format, ma_uint32 channels, ma_uint32 bufferSizeInFrames, void* pOptionalPreallocatedBuffer, ma_allocation_callbacks* pAllocationCallbacks, ma_pcm_rb* pRB);
	[CLink] public static extern void ma_pcm_rb_uninit(ma_pcm_rb* pRB);
	[CLink] public static extern void ma_pcm_rb_reset(ma_pcm_rb* pRB);
	[CLink] public static extern ma_result ma_pcm_rb_acquire_read(ma_pcm_rb* pRB, ma_uint32* pSizeInFrames, void** ppBufferOut);
	[CLink] public static extern ma_result ma_pcm_rb_commit_read(ma_pcm_rb* pRB, ma_uint32 sizeInFrames);
	[CLink] public static extern ma_result ma_pcm_rb_acquire_write(ma_pcm_rb* pRB, ma_uint32* pSizeInFrames, void** ppBufferOut);
	[CLink] public static extern ma_result ma_pcm_rb_commit_write(ma_pcm_rb* pRB, ma_uint32 sizeInFrames);
	[CLink] public static extern ma_result ma_pcm_rb_seek_read(ma_pcm_rb* pRB, ma_uint32 offsetInFrames);
	[CLink] public static extern ma_result ma_pcm_rb_seek_write(ma_pcm_rb* pRB, ma_uint32 offsetInFrames);
	[CLink] public static extern ma_int32 ma_pcm_rb_pointer_distance(ma_pcm_rb* pRB); /* Return value is in frames. */
	[CLink] public static extern ma_uint32 ma_pcm_rb_available_read(ma_pcm_rb* pRB);
	[CLink] public static extern ma_uint32 ma_pcm_rb_available_write(ma_pcm_rb* pRB);
	[CLink] public static extern ma_uint32 ma_pcm_rb_get_subbuffer_size(ma_pcm_rb* pRB);
	[CLink] public static extern ma_uint32 ma_pcm_rb_get_subbuffer_stride(ma_pcm_rb* pRB);
	[CLink] public static extern ma_uint32 ma_pcm_rb_get_subbuffer_offset(ma_pcm_rb* pRB, ma_uint32 subbufferIndex);
	[CLink] public static extern void* ma_pcm_rb_get_subbuffer_ptr(ma_pcm_rb* pRB, ma_uint32 subbufferIndex, void* pBuffer);
	[CLink] public static extern ma_format ma_pcm_rb_get_format(ma_pcm_rb* pRB);
	[CLink] public static extern ma_uint32 ma_pcm_rb_get_channels(ma_pcm_rb* pRB);
	[CLink] public static extern ma_uint32 ma_pcm_rb_get_sample_rate(ma_pcm_rb* pRB);
	[CLink] public static extern void ma_pcm_rb_set_sample_rate(ma_pcm_rb* pRB, ma_uint32 sampleRate);
	...
	*/
	...
	[CLink] public static extern ma_result ma_duplex_rb_init(ma_format captureFormat, ma_uint32 captureChannels, ma_uint32 sampleRate, ma_uint32 captureInternalSampleRate, ma_uint32 captureInternalPeriodSizeInFrames, ma_allocation_callbacks* pAllocationCallbacks, ma_duplex_rb* pRB);
	[CLink] public static extern ma_result ma_duplex_rb_uninit(ma_duplex_rb* pRB);
	...
	*/
	[CLink] public static extern char* ma_result_description(ma_result result);

	/*
	malloc()
	*/
	[CLink] public static extern void* ma_malloc(size_t sz, ma_allocation_callbacks* pAllocationCallbacks);

	/*
	calloc()
	*/
	[CLink] public static extern void* ma_calloc(size_t sz, ma_allocation_callbacks* pAllocationCallbacks);

	/*
	realloc()
	*/
	[CLink] public static extern void* ma_realloc(void* p, size_t sz, ma_allocation_callbacks* pAllocationCallbacks);

	/*
	free()
	*/
	[CLink] public static extern void ma_free(void* p, ma_allocation_callbacks* pAllocationCallbacks);

	/*
	Performs an aligned malloc, with the assumption that the alignment is a power of 2.
	*/
	[CLink] public static extern void* ma_aligned_malloc(size_t sz, size_t alignment, ma_allocation_callbacks* pAllocationCallbacks);

	/*
	Free's an aligned malloc'd buffer.
	*/
	[CLink] public static extern void ma_aligned_free(void* p, ma_allocation_callbacks* pAllocationCallbacks);

	/*
	Retrieves a friendly name for a format.
	*/
	[CLink] public static extern char* ma_get_format_name(ma_format format);

	/*
	Blends two frames in floating point format.
	*/
	[CLink] public static extern void ma_blend_f32(float* pOut, float* pInA, float* pInB, float factor, ma_uint32 channels);
	...
	Thread Safety: SAFE
	  This API is pure.
	*/
	[CLink] public static extern ma_uint32 ma_get_bytes_per_sample(ma_format format);
	//[CLink] public static extern ma_uint32 ma_get_bytes_per_frame(ma_format format, ma_uint32 channels) { return ma_get_bytes_per_sample(format) * channels; }
	...
	*/
	[CLink] public static extern char* ma_log_level_to_string(ma_uint32 logLevel);
	...
	************************************************************************************************************************************************************/
	...
	Locks a spinlock.
	*/
	[CLink] public static extern ma_result ma_spinlock_lock(ma_spinlock* pSpinlock);

	/*
	Locks a spinlock, but does not yield() when looping.
	*/
	[CLink] public static extern ma_result ma_spinlock_lock_noyield(ma_spinlock* pSpinlock);

	/*
	Unlocks a spinlock.
	*/
	[CLink] public static extern ma_result ma_spinlock_unlock(ma_spinlock* pSpinlock);
	...
	*/
	[CLink] public static extern ma_result ma_mutex_init(ma_mutex* pMutex);

	/*
	Deletes a mutex.
	*/
	[CLink] public static extern void ma_mutex_uninit(ma_mutex* pMutex);

	/*
	Locks a mutex with an infinite timeout.
	*/
	[CLink] public static extern void ma_mutex_lock(ma_mutex* pMutex);

	/*
	Unlocks a mutex.
	*/
	[CLink] public static extern void ma_mutex_unlock(ma_mutex* pMutex);


	/*
	Initializes an auto-reset event.
	*/
	[CLink] public static extern ma_result ma_event_init(ma_event* pEvent);

	/*
	Uninitializes an auto-reset event.
	*/
	[CLink] public static extern void ma_event_uninit(ma_event* pEvent);

	/*
	Waits for the specified auto-reset event to become signalled.
	*/
	[CLink] public static extern ma_result ma_event_wait(ma_event* pEvent);

	/*
	Signals the specified auto-reset event.
	*/
	[CLink] public static extern ma_result ma_event_signal(ma_event* pEvent);
#endif /* MA_NO_THREADING */ 
	...
	*/
	...
	[CLink] public static extern ma_result ma_fence_init(ma_fence* pFence);
	[CLink] public static extern void ma_fence_uninit(ma_fence* pFence);
	[CLink] public static extern ma_result ma_fence_acquire(ma_fence* pFence);    /* Increment counter. */
	[CLink] public static extern ma_result ma_fence_release(ma_fence* pFence);    /* Decrement counter. */
	[CLink] public static extern ma_result ma_fence_wait(ma_fence* pFence);       /* Wait for counter to reach 0. */
	
	/*
	Notification callback for asynchronous operations.
	*/
	typealias ma_async_notification = void;
	
	[CRepr]
	public struct ma_async_notification_callbacks
	{
	    function void (ma_async_notification* pNotification) onSignal;
	}
	
	[CLink] public static extern ma_result ma_async_notification_signal(ma_async_notification* pNotification);
	...
	*/
	...
	[CLink] public static extern ma_result ma_async_notification_poll_init(ma_async_notification_poll* pNotificationPoll);
	[CLink] public static extern ma_bool32 ma_async_notification_poll_is_signalled( ma_async_notification_poll* pNotificationPoll);
	...
	*/
	...
	[CLink] public static extern ma_result ma_async_notification_event_init(ma_async_notification_event* pNotificationEvent);
	[CLink] public static extern ma_result ma_async_notification_event_uninit(ma_async_notification_event* pNotificationEvent);
	[CLink] public static extern ma_result ma_async_notification_event_wait(ma_async_notification_event* pNotificationEvent);
	[CLink] public static extern ma_result ma_async_notification_event_signal(ma_async_notification_event* pNotificationEvent);
	...
	*/
	...
	[CLink] public static extern ma_slot_allocator_config ma_slot_allocator_config_init(ma_uint32 capacity);
	...
	[CLink] public static extern ma_result ma_slot_allocator_get_heap_size(ma_slot_allocator_config* pConfig, size_t* pHeapSizeInBytes);
	[CLink] public static extern ma_result ma_slot_allocator_init_preallocated(ma_slot_allocator_config* pConfig, void* pHeap, ma_slot_allocator* pAllocator);
	[CLink] public static extern ma_result ma_slot_allocator_init( ma_slot_allocator_config* pConfig, ma_allocation_callbacks* pAllocationCallbacks, ma_slot_allocator* pAllocator);
	[CLink] public static extern void ma_slot_allocator_uninit(ma_slot_allocator* pAllocator, ma_allocation_callbacks* pAllocationCallbacks);
	[CLink] public static extern ma_result ma_slot_allocator_alloc(ma_slot_allocator* pAllocator, ma_uint64* pSlot);
	[CLink] public static extern ma_result ma_slot_allocator_free(ma_slot_allocator* pAllocator, ma_uint64 slot);
	
	
	/*[CRepr]
	public struct ma_job ma_job;*/
	...
	*/
	...
	[CLink] public static extern ma_job ma_job_init(ma_uint16 code);
	[CLink] public static extern ma_result ma_job_process(ma_job* pJob);
	...
	*/
	public enum ma_job_queue_flags : c_int
	{
	...
	[CLink] public static extern ma_job_queue_config ma_job_queue_config_init(ma_uint32 flags, ma_uint32 capacity);
	...
	public struct ma_job_queue
	{
	    ...
	    ma_job* pJobs;
	#if !MA_USE_EXPERIMENTAL_LOCK_FREE_JOB_QUEUE
	    ma_spinlock lock;
	#endif
	...
	[CLink] public static extern ma_result ma_job_queue_get_heap_size(ma_job_queue_config* pConfig, size_t* pHeapSizeInBytes);
	[CLink] public static extern ma_result ma_job_queue_init_preallocated(ma_job_queue_config* pConfig, void* pHeap, ma_job_queue* pQueue);
	[CLink] public static extern ma_result ma_job_queue_init(ma_job_queue_config* pConfig, ma_allocation_callbacks* pAllocationCallbacks, ma_job_queue* pQueue);
	[CLink] public static extern void ma_job_queue_uninit(ma_job_queue* pQueue, ma_allocation_callbacks* pAllocationCallbacks);
	[CLink] public static extern ma_result ma_job_queue_post(ma_job_queue* pQueue, ma_job* pJob);
	[CLink] public static extern ma_result ma_job_queue_next(ma_job_queue* pQueue, ma_job* pJob); /* Returns MA_CANCELLED if the next job is a quit job. */
	...
	************************************************************************************************************************************************************/
	...
	public enum ma_device_state : c_int
	{
	...
	[CRepr]
	public struct ma_IMMNotificationClient
	{
	    void* lpVtbl;
	    ma_uint32 counter;
	    ma_device* pDevice;
	...
	//const c_int MA_BACKEND_COUNT = ma_backend_null + 1;
	...
	*/
	...
	[CLink] public static extern ma_device_job_thread_config ma_device_job_thread_config_init();
	...
	[CLink] public static extern ma_result ma_device_job_thread_init(ma_device_job_thread_config* pConfig, ma_allocation_callbacks* pAllocationCallbacks, ma_device_job_thread* pJobThread);
	[CLink] public static extern void ma_device_job_thread_uninit(ma_device_job_thread* pJobThread, ma_allocation_callbacks* pAllocationCallbacks);
	[CLink] public static extern ma_result ma_device_job_thread_post(ma_device_job_thread* pJobThread, ma_job* pJob);
	[CLink] public static extern ma_result ma_device_job_thread_next(ma_device_job_thread* pJobThread, ma_job* pJob);
	
	
	
	/* Device notification types. */
	public enum ma_device_notification_type : c_int
	{
	...
	*/
	public function void ma_device_notification_proc(ma_device_notification* pNotification);
	...
	*/
	public function void ma_device_data_proc(ma_device* pDevice, void* pOutput, void* pInput, ma_uint32 frameCount);
	...
	Do not restart or uninitialize the device from the callback.
	*/
	public function void ma_stop_proc(ma_device* pDevice);  /* DEPRECATED. Use ma_device_notification_proc instead. */
	
	public enum ma_device_type : c_int
	{
	...
	public enum ma_share_mode : c_int
	{
	...
	public enum ma_ios_session_category : c_int
	{
	...
	public enum ma_ios_session_category_option : c_int
	{
	...
	/* OpenSL stream types. */
	public enum ma_opensl_stream_type : c_int
	{
	...
	public enum ma_opensl_recording_preset : c_int
	{
	...
	public enum ma_wasapi_usage : c_int
	{
	...
	/* AAudio usage types. */
	public enum ma_aaudio_usage : c_int
	{
	...
	public enum ma_aaudio_content_type : c_int
	{
	...
	public enum ma_aaudio_input_preset : c_int
	{ 
	...
	public enum ma_aaudio_allowed_capture_policy : c_int
	{
	...
	{
	    ma_wchar_win32[64] wasapi;      /* WASAPI uses a wchar_t string for identification. */
	    ma_uint8[16] dsound;            /* DirectSound uses a GUID for identification. */
	    ...
	    char[256] alsa;                 /* ALSA uses a name string for identification. */
	    char[256] pulse;                /* PulseAudio uses a name string for identification. */
	    c_int jack;                       /* JACK always uses default devices. */
	    char[256] coreaudio;            /* Core Audio uses a string for identification. */
	    char[256] sndio;                /* "snd/0", etc. */
	    char[256] audio4;               /* "/dev/audio", etc. */
	    char[64] oss;                   /* "dev/dsp0", etc. "dev/dsp" for the default device. */
	    ...
	    char[32] webaudio;              /* Web Audio always uses default devices for now, but if this changes it'll be a GUID. */
	    [Union] public struct 
	    {
	        c_int i;
	        char[256] s;
	    ...
	    c_int nullbackend;                /* The null backend uses an integer for device IDs. */
	}
	
	
	/*[CRepr]
	public struct ma_context_config    ma_context_config;

	[CRepr]
	public struct ma_device_config     ma_device_config;

	[CRepr]
	public struct ma_backend_callbacks ma_backend_callbacks;*/
	
	const c_int MA_DATA_FORMAT_FLAG_EXCLUSIVE_MODE = (1U << 1);    /* If set, this is supported in exclusive mode. Otherwise not natively supported by exclusive mode. */
	
#if !MA_MAX_DEVICE_NAME_LENGTH
	const c_int MA_MAX_DEVICE_NAME_LENGTH   = 255;
#endif
	...
	public struct ma_device_info
	{
	    ...
	    ma_device_id id;
	    char[MA_MAX_DEVICE_NAME_LENGTH + 1] name;   /* +1 for null terminator. */
	    ma_bool32 isDefault;
	
	    ma_uint32 nativeDataFormatCount;
	 	ma_native_data_format[64] nativeDataFormats; //[/*ma_format_count * ma_standard_sample_rate_count * MA_MAX_CHANNELS*/ 64];  /* Not sure how big to make this. There can be *many* permutations for virtual devices which can support anything. */
	}
	...
	public struct ma_device_config
	{
	    ...
	    public ma_stop_proc stopCallback;
	    ...
	    public struct 
	    {
	        public char* pStreamNamePlayback;
	        public char* pStreamNameCapture;
	    } pulse;
	...
	*/
	function ma_bool32 ma_enum_devices_callback_proc(ma_context* pContext, ma_device_type deviceType, ma_device_info* pInfo, void* pUserData);
	...
	*/
	...
	public struct ma_device_descriptor
	{
	    ...
	    ma_uint32 channels;
	    ma_uint32 sampleRate;
	    ma_channel[MA_MAX_CHANNELS] channelMap;
	...
	*/
	...
	{
	    function ma_result(ma_context* pContext, ma_context_config* pConfig, ma_backend_callbacks* pCallbacks) onContextInit;
	    function ma_result(ma_context* pContext) onContextUninit;
	    function ma_result(ma_context* pContext, ma_enum_devices_callback_proc callback, void* pUserData) onContextEnumerateDevices;
	    function ma_result(ma_context* pContext, ma_device_type deviceType, ma_device_id* pDeviceID, ma_device_info* pDeviceInfo) onContextGetDeviceInfo;
	    function ma_result(ma_device* pDevice, ma_device_config* pConfig, ma_device_descriptor* pDescriptorPlayback, ma_device_descriptor* pDescriptorCapture) onDeviceInit;
	    function ma_result(ma_device* pDevice) onDeviceUninit;
	    function ma_result(ma_device* pDevice) onDeviceStart;
	    function ma_result(ma_device* pDevice) onDeviceStop;
	    function ma_result(ma_device* pDevice, void* pFrames, ma_uint32 frameCount, ma_uint32* pFramesRead) onDeviceRead;
	    function ma_result(ma_device* pDevice, void* pFrames, ma_uint32 frameCount, ma_uint32* pFramesWritten) onDeviceWrite;
	    function ma_result(ma_device* pDevice) onDeviceDataLoop;
	    function ma_result(ma_device* pDevice) onDeviceDataLoopWakeup;
	    function ma_result(ma_device* pDevice, ma_device_type type, ma_device_info* pDeviceInfo) onDeviceGetInfo;
	}
	...
	public struct ma_device
	{
	    ...
	    struct playback
	    {
	        ...
	        char[MA_MAX_DEVICE_NAME_LENGTH + 1] name;                     /* Maybe temporary. Likely to be replaced with a query API. */
	        ...
	        ma_channel[MA_MAX_CHANNELS] internalChannelMap;
	    ...
	    [Union] struct backend
	    {
	        ...
	        struct
	        {
	            ...
	            c_int pollDescriptorCountPlayback;
	            c_int pollDescriptorCountCapture;
	            c_int wakeupfdPlayback;   /* eventfd for waking up from poll() when the playback device is stopped. */
	            c_int wakeupfdCapture;    /* eventfd for waking up from poll() when the capture device is stopped. */
	        ...
	        {
	            /* AudioWorklets path. */
	            /* EMSCRIPTEN_WEBAUDIO_T */ c_int audioContext;
	            /* EMSCRIPTEN_WEBAUDIO_T */ c_int audioWorklet;
	            float* pIntermediaryBuffer;
	            void* pStackBuffer;
	            ma_result initResult;   /* Set to MA_BUSY while initialization is in progress. */
	            c_int deviceIndex;        /* We store the device in a list on the JavaScript side. This is used to map our C object to the JS object. */
	        } webaudio;
#endif
#if MA_SUPPORT_NULL
	        struct
	...
	ma_context_init()
	*/
	[CLink] public static extern ma_context_config ma_context_config_init();
	...
	ma_context_uninit()
	*/
	[CLink] public static extern ma_result ma_context_init(ma_backend[] backends, ma_uint32 backendCount, ma_context_config* pConfig, ma_context* pContext);
	...
	ma_context_init()
	*/
	[CLink] public static extern ma_result ma_context_uninit(ma_context* pContext);
	...
	*/
	[CLink] public static extern size_t ma_context_sizeof();
	...
	*/
	[CLink] public static extern ma_log* ma_context_get_log(ma_context* pContext);
	...
	------------------------------
	ma_bool32 ma_device_enum_callback(ma_context* pContext, ma_device_type deviceType, ma_device_info* pInfo, void* pUserData)
	{
	...
	*/
	[CLink] public static extern ma_result ma_context_enumerate_devices(ma_context* pContext, ma_enum_devices_callback_proc callback, void* pUserData);
	...
	ma_context_get_devices()
	*/
	[CLink] public static extern ma_result ma_context_get_devices(ma_context* pContext, ma_device_info** ppPlaybackDeviceInfos, ma_uint32* pPlaybackDeviceCount, ma_device_info** ppCaptureDeviceInfos, ma_uint32* pCaptureDeviceCount);
	...
	*/
	[CLink] public static extern ma_result ma_context_get_device_info(ma_context* pContext, ma_device_type deviceType, ma_device_id* pDeviceID, ma_device_info* pDeviceInfo);
	...
	*/
	[CLink] public static extern ma_bool32 ma_context_is_loopback_supported(ma_context* pContext);
	...
	ma_device_init_ex()
	*/
	[CLink] public static extern ma_device_config ma_device_config_init(ma_device_type deviceType);
	...
	*/
	[CLink] public static extern ma_result ma_device_init(ma_context* pContext, ma_device_config* pConfig, ma_device* pDevice);
	...
	ma_context_init()
	*/
	[CLink] public static extern ma_result ma_device_init_ex(ma_backend[] backends, ma_uint32 backendCount, ma_context_config* pContextConfig, ma_device_config* pConfig, ma_device* pDevice);
	...
	ma_device_stop()
	*/
	[CLink] public static extern void ma_device_uninit(ma_device* pDevice);
	
	
	/*
	Retrieves a pointer to the context that owns the given device.
	*/
	[CLink] public static extern ma_context* ma_device_get_context(ma_device* pDevice);
	
	/*
	Helper function for retrieving the log object associated with the context that owns this device.
	*/
	[CLink] public static extern ma_log* ma_device_get_log(ma_device* pDevice);
	...
	*/
	[CLink] public static extern ma_result ma_device_get_info(ma_device* pDevice, ma_device_type type, ma_device_info* pDeviceInfo);
	...
	*/
	[CLink] public static extern ma_result ma_device_get_name(ma_device* pDevice, ma_device_type type, char* pName, size_t nameCap, size_t* pLengthNotIncludingNullTerminator);
	...
	ma_device_stop()
	*/
	[CLink] public static extern ma_result ma_device_start(ma_device* pDevice);
	...
	ma_device_start()
	*/
	[CLink] public static extern ma_result ma_device_stop(ma_device* pDevice);
	...
	ma_device_stop()
	*/
	[CLink] public static extern ma_bool32 ma_device_is_started(ma_device* pDevice);
	...
	synchronization.
	*/
	[CLink] public static extern ma_device_state ma_device_get_state(ma_device* pDevice);
	...
	*/
	[CLink] public static extern ma_result ma_device_post_init(ma_device* pDevice, ma_device_type deviceType, ma_device_descriptor* pPlaybackDescriptor, ma_device_descriptor* pCaptureDescriptor);
	...
	*/
	[CLink] public static extern ma_result ma_device_set_master_volume(ma_device* pDevice, float volume);
	...
	*/
	[CLink] public static extern ma_result ma_device_get_master_volume(ma_device* pDevice, float* pVolume);
	...
	ma_device_get_master_volume()
	*/
	[CLink] public static extern ma_result ma_device_set_master_volume_db(ma_device* pDevice, float gainDB);
	...
	ma_device_get_master_volume()
	*/
	[CLink] public static extern ma_result ma_device_get_master_volume_db(ma_device* pDevice, float* pGainDB);
	...
	callback.
	*/
	[CLink] public static extern ma_result ma_device_handle_backend_data_callback(ma_device* pDevice, void* pOutput, void* pInput, ma_uint32 frameCount);
	...
	*/
	[CLink] public static extern ma_uint32 ma_calculate_buffer_size_in_frames_from_descriptor(ma_device_descriptor* pDescriptor, ma_uint32 nativeSampleRate, ma_performance_profile performanceProfile);
	...
	*/
	[CLink] public static extern char* ma_get_backend_name(ma_backend backend);
	
	/*
	Retrieves the backend enum from the given name.
	*/
	[CLink] public static extern ma_result ma_get_backend_from_name(char* pBackendName, ma_backend* pBackend);
	
	/*
	Determines whether or not the given backend is available by the compilation environment.
	*/
	[CLink] public static extern ma_bool32 ma_is_backend_enabled(ma_backend backend);
	...
	*/
	[CLink] public static extern ma_result ma_get_enabled_backends(ma_backend* pBackends, size_t backendCap, size_t* pBackendCount);
	
	/*
	Determines whether or not loopback mode is support by a backend.
	*/
	[CLink] public static extern ma_bool32 ma_is_loopback_supported(ma_backend backend);
	...
	*/
	[CLink] public static extern ma_uint32 ma_calculate_buffer_size_in_milliseconds_from_frames(ma_uint32 bufferSizeInFrames, ma_uint32 sampleRate);
	
	/*
	Calculates a buffer size in frames from the specified number of milliseconds and sample rate.
	*/
	[CLink] public static extern ma_uint32 ma_calculate_buffer_size_in_frames_from_milliseconds(ma_uint32 bufferSizeInMilliseconds, ma_uint32 sampleRate);
	
	/*
	Copies PCM frames from one buffer to another.
	*/
	[CLink] public static extern void ma_copy_pcm_frames(void* dst, void* src, ma_uint64 frameCount, ma_format format, ma_uint32 channels);
	...
	*/
	[CLink] public static extern void ma_silence_pcm_frames(void* p, ma_uint64 frameCount, ma_format format, ma_uint32 channels);
	
	
	/*
	Offsets a pointer by the specified number of PCM frames.
	*/
	[CLink] public static extern void* ma_offset_pcm_frames_ptr(void* p, ma_uint64 offsetInFrames, ma_format format, ma_uint32 channels);
	[CLink] public static extern void* ma_offset_pcm_frames_const_ptr(void* p, ma_uint64 offsetInFrames, ma_format format, ma_uint32 channels);
	...
	static MA_INLINE float* ma_offset_pcm_frames_const_ptr_f32(float* p, ma_uint64 offsetInFrames, ma_uint32 channels) { return (float*)ma_offset_pcm_frames_const_ptr((void*)p, offsetInFrames, ma_format_f32, channels); }*/
	
	
	/*
	Clips samples.
	*/
	[CLink] public static extern void ma_clip_samples_u8(ma_uint8* pDst, ma_int16* pSrc, ma_uint64 count);
	[CLink] public static extern void ma_clip_samples_s16(ma_int16* pDst, ma_int32* pSrc, ma_uint64 count);
	[CLink] public static extern void ma_clip_samples_s24(ma_uint8* pDst, ma_int64* pSrc, ma_uint64 count);
	[CLink] public static extern void ma_clip_samples_s32(ma_int32* pDst, ma_int64* pSrc, ma_uint64 count);
	[CLink] public static extern void ma_clip_samples_f32(float* pDst, float* pSrc, ma_uint64 count);
	[CLink] public static extern void ma_clip_pcm_frames(void* pDst, void* pSrc, ma_uint64 frameCount, ma_format format, ma_uint32 channels);
	...
	*/
	[CLink] public static extern void ma_copy_and_apply_volume_factor_u8(ma_uint8* pSamplesOut, ma_uint8* pSamplesIn, ma_uint64 sampleCount, float factor);
	[CLink] public static extern void ma_copy_and_apply_volume_factor_s16(ma_int16* pSamplesOut, ma_int16* pSamplesIn, ma_uint64 sampleCount, float factor);
	[CLink] public static extern void ma_copy_and_apply_volume_factor_s24(void* pSamplesOut, void* pSamplesIn, ma_uint64 sampleCount, float factor);
	[CLink] public static extern void ma_copy_and_apply_volume_factor_s32(ma_int32* pSamplesOut, ma_int32* pSamplesIn, ma_uint64 sampleCount, float factor);
	[CLink] public static extern void ma_copy_and_apply_volume_factor_f32(float* pSamplesOut, float* pSamplesIn, ma_uint64 sampleCount, float factor);
	
	[CLink] public static extern void ma_apply_volume_factor_u8(ma_uint8* pSamples, ma_uint64 sampleCount, float factor);
	[CLink] public static extern void ma_apply_volume_factor_s16(ma_int16* pSamples, ma_uint64 sampleCount, float factor);
	[CLink] public static extern void ma_apply_volume_factor_s24(void* pSamples, ma_uint64 sampleCount, float factor);
	[CLink] public static extern void ma_apply_volume_factor_s32(ma_int32* pSamples, ma_uint64 sampleCount, float factor);
	[CLink] public static extern void ma_apply_volume_factor_f32(float* pSamples, ma_uint64 sampleCount, float factor);
	
	[CLink] public static extern void ma_copy_and_apply_volume_factor_pcm_frames_u8(ma_uint8* pFramesOut, ma_uint8* pFramesIn, ma_uint64 frameCount, ma_uint32 channels, float factor);
	[CLink] public static extern void ma_copy_and_apply_volume_factor_pcm_frames_s16(ma_int16* pFramesOut, ma_int16* pFramesIn, ma_uint64 frameCount, ma_uint32 channels, float factor);
	[CLink] public static extern void ma_copy_and_apply_volume_factor_pcm_frames_s24(void* pFramesOut, void* pFramesIn, ma_uint64 frameCount, ma_uint32 channels, float factor);
	[CLink] public static extern void ma_copy_and_apply_volume_factor_pcm_frames_s32(ma_int32* pFramesOut, ma_int32* pFramesIn, ma_uint64 frameCount, ma_uint32 channels, float factor);
	[CLink] public static extern void ma_copy_and_apply_volume_factor_pcm_frames_f32(float* pFramesOut, float* pFramesIn, ma_uint64 frameCount, ma_uint32 channels, float factor);
	[CLink] public static extern void ma_copy_and_apply_volume_factor_pcm_frames(void* pFramesOut, void* pFramesIn, ma_uint64 frameCount, ma_format format, ma_uint32 channels, float factor);
	
	[CLink] public static extern void ma_apply_volume_factor_pcm_frames_u8(ma_uint8* pFrames, ma_uint64 frameCount, ma_uint32 channels, float factor);
	[CLink] public static extern void ma_apply_volume_factor_pcm_frames_s16(ma_int16* pFrames, ma_uint64 frameCount, ma_uint32 channels, float factor);
	[CLink] public static extern void ma_apply_volume_factor_pcm_frames_s24(void* pFrames, ma_uint64 frameCount, ma_uint32 channels, float factor);
	[CLink] public static extern void ma_apply_volume_factor_pcm_frames_s32(ma_int32* pFrames, ma_uint64 frameCount, ma_uint32 channels, float factor);
	[CLink] public static extern void ma_apply_volume_factor_pcm_frames_f32(float* pFrames, ma_uint64 frameCount, ma_uint32 channels, float factor);
	[CLink] public static extern void ma_apply_volume_factor_pcm_frames(void* pFrames, ma_uint64 frameCount, ma_format format, ma_uint32 channels, float factor);
	
	[CLink] public static extern void ma_copy_and_apply_volume_factor_per_channel_f32(float* pFramesOut, float* pFramesIn, ma_uint64 frameCount, ma_uint32 channels, float* pChannelGains);
	
	
	[CLink] public static extern void ma_copy_and_apply_volume_and_clip_samples_u8(ma_uint8* pDst, ma_int16* pSrc, ma_uint64 count, float volume);
	[CLink] public static extern void ma_copy_and_apply_volume_and_clip_samples_s16(ma_int16* pDst, ma_int32* pSrc, ma_uint64 count, float volume);
	[CLink] public static extern void ma_copy_and_apply_volume_and_clip_samples_s24(ma_uint8* pDst, ma_int64* pSrc, ma_uint64 count, float volume);
	[CLink] public static extern void ma_copy_and_apply_volume_and_clip_samples_s32(ma_int32* pDst, ma_int64* pSrc, ma_uint64 count, float volume);
	[CLink] public static extern void ma_copy_and_apply_volume_and_clip_samples_f32(float* pDst, float* pSrc, ma_uint64 count, float volume);
	[CLink] public static extern void ma_copy_and_apply_volume_and_clip_pcm_frames(void* pDst, void* pSrc, ma_uint64 frameCount, ma_format format, ma_uint32 channels, float volume);
	
	
	/*
	Helper for converting a linear factor to gain in decibels.
	*/
	[CLink] public static extern float ma_volume_linear_to_db(float factor);
	
	/*
	Helper for converting gain in decibels to a linear factor.
	*/
	[CLink] public static extern float ma_volume_db_to_linear(float gain);
	...
	*/
	[CLink] public static extern ma_result ma_mix_pcm_frames_f32(float* pDst, float* pSrc, ma_uint64 frameCount, ma_uint32 channels, float volume);
	...
	************************************************************************************************************************************************************/
	typealias ma_vfs = void;
	typealias ma_vfs_file = ma_handle;
	
	public enum ma_open_mode_flags : c_int
	{
	    MA_OPEN_MODE_READ  = 0x00000001,
	    MA_OPEN_MODE_WRITE = 0x00000002
	}
	
	public enum ma_seek_origin : c_int
	{
	...
	{
	    function ma_result(ma_vfs* pVFS, char* pFilePath, ma_uint32 openMode, ma_vfs_file* pFile) onOpen;
	    function ma_result(ma_vfs* pVFS, wchar_t* pFilePath, ma_uint32 openMode, ma_vfs_file* pFile) onOpenW;
	    function ma_result(ma_vfs* pVFS, ma_vfs_file file) onClose;
	    function ma_result(ma_vfs* pVFS, ma_vfs_file file, void* pDst, size_t sizeInBytes, size_t* pBytesRead) onRead;
	    function ma_result(ma_vfs* pVFS, ma_vfs_file file, void* pSrc, size_t sizeInBytes, size_t* pBytesWritten) onWrite;
	    function ma_result(ma_vfs* pVFS, ma_vfs_file file, ma_int64 offset, ma_seek_origin origin) onSeek;
	    function ma_result(ma_vfs* pVFS, ma_vfs_file file, ma_int64* pCursor) onTell;
	    function ma_result(ma_vfs* pVFS, ma_vfs_file file, ma_file_info* pInfo) onInfo;
	}
	
	[CLink] public static extern ma_result ma_vfs_open(ma_vfs* pVFS, char* pFilePath, ma_uint32 openMode, ma_vfs_file* pFile);
	[CLink] public static extern ma_result ma_vfs_open_w(ma_vfs* pVFS, wchar_t* pFilePath, ma_uint32 openMode, ma_vfs_file* pFile);
	[CLink] public static extern ma_result ma_vfs_close(ma_vfs* pVFS, ma_vfs_file file);
	[CLink] public static extern ma_result ma_vfs_read(ma_vfs* pVFS, ma_vfs_file file, void* pDst, size_t sizeInBytes, size_t* pBytesRead);
	[CLink] public static extern ma_result ma_vfs_write(ma_vfs* pVFS, ma_vfs_file file, void* pSrc, size_t sizeInBytes, size_t* pBytesWritten);
	[CLink] public static extern ma_result ma_vfs_seek(ma_vfs* pVFS, ma_vfs_file file, ma_int64 offset, ma_seek_origin origin);
	[CLink] public static extern ma_result ma_vfs_tell(ma_vfs* pVFS, ma_vfs_file file, ma_int64* pCursor);
	[CLink] public static extern ma_result ma_vfs_info(ma_vfs* pVFS, ma_vfs_file file, ma_file_info* pInfo);
	[CLink] public static extern ma_result ma_vfs_open_and_read_file(ma_vfs* pVFS, char* pFilePath, void** ppData, size_t* pSize, ma_allocation_callbacks* pAllocationCallbacks);
	...
	[CLink] public static extern ma_result ma_default_vfs_init(ma_default_vfs* pVFS, ma_allocation_callbacks* pAllocationCallbacks);


	function ma_result ma_read_proc(void* pUserData, void* pBufferOut, size_t bytesToRead, size_t* pBytesRead);
	function ma_result ma_seek_proc(void* pUserData, ma_int64 offset, ma_seek_origin origin);
	function ma_result ma_tell_proc(void* pUserData, ma_int64* pCursor);
	
#if !MA_NO_DECODING || !MA_NO_ENCODING
	public enum ma_encoding_format : c_int
	{
	...
	************************************************************************************************************************************************************/
#if !MA_NO_DECODING
	/*[CRepr]
	public struct ma_decoder ma_decoder;*/
	...
	[CLink] public static extern ma_decoding_backend_config ma_decoding_backend_config_init(ma_format preferredFormat, ma_uint32 seekPointCount);
	
	
	[CRepr]
	public struct ma_decoding_backend_vtable
	{
	    function ma_result(void* pUserData, ma_read_proc onRead, ma_seek_proc onSeek, ma_tell_proc onTell, void* pReadSeekTellUserData, ma_decoding_backend_config* pConfig, ma_allocation_callbacks* pAllocationCallbacks, ma_data_source** ppBackend) onInit;
	    function ma_result(void* pUserData, char* pFilePath, ma_decoding_backend_config* pConfig, ma_allocation_callbacks* pAllocationCallbacks, ma_data_source** ppBackend) onInitFile;               /* Optional. */
	    function ma_result(void* pUserData, wchar_t* pFilePath, ma_decoding_backend_config* pConfig, ma_allocation_callbacks* pAllocationCallbacks, ma_data_source** ppBackend) onInitFileW;            /* Optional. */
	    function ma_result(void* pUserData, void* pData, size_t dataSize, ma_decoding_backend_config* pConfig, ma_allocation_callbacks* pAllocationCallbacks, ma_data_source** ppBackend) onInitMemory;  /* Optional. */
	    function void(void* pUserData, ma_data_source* pBackend, ma_allocation_callbacks* pAllocationCallbacks) onUninit;
	}
	
	
	function ma_result ma_decoder_read_proc(ma_decoder* pDecoder, void* pBufferOut, size_t bytesToRead, size_t* pBytesRead);  /* Returns the number of bytes read. */
	function ma_result ma_decoder_seek_proc(ma_decoder* pDecoder, ma_int64 byteOffset, ma_seek_origin origin);
	function ma_result ma_decoder_tell_proc(ma_decoder* pDecoder, ma_int64* pCursor);
	...
	struct ma_decoder
	{
	    ...
	    ma_decoding_backend_vtable* pBackendVTable; /* The vtable for the decoding backend. This needs to be stored so we can access the onUninit() callback. */
	    void* pBackendUserData;
        ...
        [Union] struct data
	    {
	        ...
	        struct memory /* Only used for decoders that were opened against a block of memory. */
	        {
	            ma_uint8* pData;
	            size_t dataSize;
	...
	[CLink] public static extern ma_decoder_config ma_decoder_config_init(ma_format outputFormat, ma_uint32 outputChannels, ma_uint32 outputSampleRate);
	[CLink] public static extern ma_decoder_config ma_decoder_config_init_default();
	
	[CLink] public static extern ma_result ma_decoder_init(ma_decoder_read_proc onRead, ma_decoder_seek_proc onSeek, void* pUserData, ma_decoder_config* pConfig, ma_decoder* pDecoder);
	[CLink] public static extern ma_result ma_decoder_init_memory(void* pData, size_t dataSize, ma_decoder_config* pConfig, ma_decoder* pDecoder);
	[CLink] public static extern ma_result ma_decoder_init_vfs(ma_vfs* pVFS, char* pFilePath, ma_decoder_config* pConfig, ma_decoder* pDecoder);
	[CLink] public static extern ma_result ma_decoder_init_vfs_w(ma_vfs* pVFS, wchar_t* pFilePath, ma_decoder_config* pConfig, ma_decoder* pDecoder);
	[CLink] public static extern ma_result ma_decoder_init_file(char* pFilePath, ma_decoder_config* pConfig, ma_decoder* pDecoder);
	[CLink] public static extern ma_result ma_decoder_init_file_w(wchar_t* pFilePath, ma_decoder_config* pConfig, ma_decoder* pDecoder);
	
	/*
	Uninitializes a decoder.
	*/
	[CLink] public static extern ma_result ma_decoder_uninit(ma_decoder* pDecoder);
	...
	*/
	[CLink] public static extern ma_result ma_decoder_read_pcm_frames(ma_decoder* pDecoder, void* pFramesOut, ma_uint64 frameCount, ma_uint64* pFramesRead);
	...
	This is not thread safe without your own synchronization.
	*/
	[CLink] public static extern ma_result ma_decoder_seek_to_pcm_frame(ma_decoder* pDecoder, ma_uint64 frameIndex);
	
	/*
	Retrieves the decoder's output data format.
	*/
	[CLink] public static extern ma_result ma_decoder_get_data_format(ma_decoder* pDecoder, ma_format* pFormat, ma_uint32* pChannels, ma_uint32* pSampleRate, ma_channel* pChannelMap, size_t channelMapCap);
	
	/*
	Retrieves the current position of the read cursor in PCM frames.
	*/
	[CLink] public static extern ma_result ma_decoder_get_cursor_in_pcm_frames(ma_decoder* pDecoder, ma_uint64* pCursor);
	...
	*/
	[CLink] public static extern ma_result ma_decoder_get_length_in_pcm_frames(ma_decoder* pDecoder, ma_uint64* pLength);
	...
	returned.
	*/
	[CLink] public static extern ma_result ma_decoder_get_available_frames(ma_decoder* pDecoder, ma_uint64* pAvailableFrames);
	
	/*
	Helper for opening and decoding a file into a heap allocated block of memory. Free the returned pointer with ma_free(). On input,
	pConfig should be set to what you want. On output it will be set to what you got.
	*/
	[CLink] public static extern ma_result ma_decode_from_vfs(ma_vfs* pVFS, char* pFilePath, ma_decoder_config* pConfig, ma_uint64* pFrameCountOut, void** ppPCMFramesOut);
	[CLink] public static extern ma_result ma_decode_file(char* pFilePath, ma_decoder_config* pConfig, ma_uint64* pFrameCountOut, void** ppPCMFramesOut);
	[CLink] public static extern ma_result ma_decode_memory(void* pData, size_t dataSize, ma_decoder_config* pConfig, ma_uint64* pFrameCountOut, void** ppPCMFramesOut);
	...
	************************************************************************************************************************************************************/
	...
	// [CRepr]
	// public struct ma_encoder ma_encoder;
	
	public function ma_result ma_encoder_write_proc(ma_encoder* pEncoder, void* pBufferIn, size_t bytesToWrite, size_t* pBytesWritten);
	public function ma_result ma_encoder_seek_proc(ma_encoder* pEncoder, ma_int64 offset, ma_seek_origin origin);
	public function ma_result ma_encoder_init_proc(ma_encoder* pEncoder);
	public function void ma_encoder_uninit_proc(ma_encoder* pEncoder);
	public function ma_result ma_encoder_write_pcm_frames_proc(ma_encoder* pEncoder, void* pFramesIn, ma_uint64 frameCount, ma_uint64* pFramesWritten);
	...
	[CLink] public static extern ma_encoder_config ma_encoder_config_init(ma_encoding_format encodingFormat, ma_format format, ma_uint32 channels, ma_uint32 sampleRate);
	...
	[CLink] public static extern ma_result ma_encoder_init(ma_encoder_write_proc onWrite, ma_encoder_seek_proc onSeek, void* pUserData, ma_encoder_config* pConfig, ma_encoder* pEncoder);
	[CLink] public static extern ma_result ma_encoder_init_vfs(ma_vfs* pVFS, char* pFilePath, ma_encoder_config* pConfig, ma_encoder* pEncoder);
	[CLink] public static extern ma_result ma_encoder_init_vfs_w(ma_vfs* pVFS, wchar_t* pFilePath, ma_encoder_config* pConfig, ma_encoder* pEncoder);
	[CLink] public static extern ma_result ma_encoder_init_file(char* pFilePath, ma_encoder_config* pConfig, ma_encoder* pEncoder);
	[CLink] public static extern ma_result ma_encoder_init_file_w(wchar_t* pFilePath, ma_encoder_config* pConfig, ma_encoder* pEncoder);
	[CLink] public static extern void ma_encoder_uninit(ma_encoder* pEncoder);
	[CLink] public static extern ma_result ma_encoder_write_pcm_frames(ma_encoder* pEncoder, void* pFramesIn, ma_uint64 frameCount, ma_uint64* pFramesWritten);
	...
	************************************************************************************************************************************************************/
	...
	public enum ma_waveform_type : c_int
	{
	    ma_waveform_type_sine,
	    ma_waveform_type_square,
	    ma_waveform_type_triangle,
	...
	[CLink] public static extern ma_waveform_config ma_waveform_config_init(ma_format format, ma_uint32 channels, ma_uint32 sampleRate, ma_waveform_type type, double amplitude, double frequency);
	...
	[CLink] public static extern ma_result ma_waveform_init(ma_waveform_config* pConfig, ma_waveform* pWaveform);
	[CLink] public static extern void ma_waveform_uninit(ma_waveform* pWaveform);
	[CLink] public static extern ma_result ma_waveform_read_pcm_frames(ma_waveform* pWaveform, void* pFramesOut, ma_uint64 frameCount, ma_uint64* pFramesRead);
	[CLink] public static extern ma_result ma_waveform_seek_to_pcm_frame(ma_waveform* pWaveform, ma_uint64 frameIndex);
	[CLink] public static extern ma_result ma_waveform_set_amplitude(ma_waveform* pWaveform, double amplitude);
	[CLink] public static extern ma_result ma_waveform_set_frequency(ma_waveform* pWaveform, double frequency);
	[CLink] public static extern ma_result ma_waveform_set_type(ma_waveform* pWaveform, ma_waveform_type type);
	[CLink] public static extern ma_result ma_waveform_set_sample_rate(ma_waveform* pWaveform, ma_uint32 sampleRate);
	...
	[CLink] public static extern ma_pulsewave_config ma_pulsewave_config_init(ma_format format, ma_uint32 channels, ma_uint32 sampleRate, double dutyCycle, double amplitude, double frequency);
	...
	[CLink] public static extern ma_result ma_pulsewave_init(ma_pulsewave_config* pConfig, ma_pulsewave* pWaveform);
	[CLink] public static extern void ma_pulsewave_uninit(ma_pulsewave* pWaveform);
	[CLink] public static extern ma_result ma_pulsewave_read_pcm_frames(ma_pulsewave* pWaveform, void* pFramesOut, ma_uint64 frameCount, ma_uint64* pFramesRead);
	[CLink] public static extern ma_result ma_pulsewave_seek_to_pcm_frame(ma_pulsewave* pWaveform, ma_uint64 frameIndex);
	[CLink] public static extern ma_result ma_pulsewave_set_amplitude(ma_pulsewave* pWaveform, double amplitude);
	[CLink] public static extern ma_result ma_pulsewave_set_frequency(ma_pulsewave* pWaveform, double frequency);
	[CLink] public static extern ma_result ma_pulsewave_set_sample_rate(ma_pulsewave* pWaveform, ma_uint32 sampleRate);
	[CLink] public static extern ma_result ma_pulsewave_set_duty_cycle(ma_pulsewave* pWaveform, double dutyCycle);
	
	public enum ma_noise_type : c_int
	{
	    ma_noise_type_white,
	    ma_noise_type_pink,
	    ma_noise_type_brownian
	...
	[CLink] public static extern ma_noise_config ma_noise_config_init(ma_format format, ma_uint32 channels, ma_noise_type type, ma_int32 seed, double amplitude);
	...
	[CLink] public static extern ma_result ma_noise_get_heap_size(ma_noise_config* pConfig, size_t* pHeapSizeInBytes);
	[CLink] public static extern ma_result ma_noise_init_preallocated(ma_noise_config* pConfig, void* pHeap, ma_noise* pNoise);
	[CLink] public static extern ma_result ma_noise_init(ma_noise_config* pConfig, ma_allocation_callbacks* pAllocationCallbacks, ma_noise* pNoise);
	[CLink] public static extern void ma_noise_uninit(ma_noise* pNoise, ma_allocation_callbacks* pAllocationCallbacks);
	[CLink] public static extern ma_result ma_noise_read_pcm_frames(ma_noise* pNoise, void* pFramesOut, ma_uint64 frameCount, ma_uint64* pFramesRead);
	[CLink] public static extern ma_result ma_noise_set_amplitude(ma_noise* pNoise, double amplitude);
	[CLink] public static extern ma_result ma_noise_set_seed(ma_noise* pNoise, ma_int32 seed);
	[CLink] public static extern ma_result ma_noise_set_type(ma_noise* pNoise, ma_noise_type type);
...
#if !MA_NO_RESOURCE_MANAGER && MA_NO_DECODING
	#define MA_NO_RESOURCE_MANAGER
#endif
	
#if !MA_NO_RESOURCE_MANAGER
	public enum ma_resource_manager_data_source_flags : c_int
	{
	...
	*/
	...
	[CLink] public static extern ma_resource_manager_pipeline_notifications ma_resource_manager_pipeline_notifications_init();
...
#if !MA_RESOURCE_MANAGER_MAX_JOB_THREAD_COUNT
	const c_int MA_RESOURCE_MANAGER_MAX_JOB_THREAD_COUNT    = 64;
#endif
	
	public enum ma_resource_manager_flags : c_int
	{
	...
	[CLink] public static extern ma_resource_manager_data_source_config ma_resource_manager_data_source_config_init();
	
	
	public enum ma_resource_manager_data_supply_type : c_int
	{
	...
	[CLink] public static extern ma_resource_manager_config ma_resource_manager_config_init();
	...
	public struct ma_resource_manager
	{
	    ...
	    ma_thread[MA_RESOURCE_MANAGER_MAX_JOB_THREAD_COUNT] jobThreads; /* The threads for executing jobs. */
#endif
	...
	/* Init. */
	[CLink] public static extern ma_result ma_resource_manager_init(ma_resource_manager_config* pConfig, ma_resource_manager* pResourceManager);
	[CLink] public static extern void ma_resource_manager_uninit(ma_resource_manager* pResourceManager);
	[CLink] public static extern ma_log* ma_resource_manager_get_log(ma_resource_manager* pResourceManager);
	
	/* Registration. */
	[CLink] public static extern ma_result ma_resource_manager_register_file(ma_resource_manager* pResourceManager, char* pFilePath, ma_uint32 flags);
	[CLink] public static extern ma_result ma_resource_manager_register_file_w(ma_resource_manager* pResourceManager, wchar_t* pFilePath, ma_uint32 flags);
	[CLink] public static extern ma_result ma_resource_manager_register_decoded_data(ma_resource_manager* pResourceManager, char* pName, void* pData, ma_uint64 frameCount, ma_format format, ma_uint32 channels, ma_uint32 sampleRate);  /* Does not copy. Increments the reference count if already exists and returns MA_SUCCESS. */
	[CLink] public static extern ma_result ma_resource_manager_register_decoded_data_w(ma_resource_manager* pResourceManager, wchar_t* pName, void* pData, ma_uint64 frameCount, ma_format format, ma_uint32 channels, ma_uint32 sampleRate);
	[CLink] public static extern ma_result ma_resource_manager_register_encoded_data(ma_resource_manager* pResourceManager, char* pName, void* pData, size_t sizeInBytes);    /* Does not copy. Increments the reference count if already exists and returns MA_SUCCESS. */
	[CLink] public static extern ma_result ma_resource_manager_register_encoded_data_w(ma_resource_manager* pResourceManager, wchar_t* pName, void* pData, size_t sizeInBytes);
	[CLink] public static extern ma_result ma_resource_manager_unregister_file(ma_resource_manager* pResourceManager, char* pFilePath);
	[CLink] public static extern ma_result ma_resource_manager_unregister_file_w(ma_resource_manager* pResourceManager, wchar_t* pFilePath);
	[CLink] public static extern ma_result ma_resource_manager_unregister_data(ma_resource_manager* pResourceManager, char* pName);
	[CLink] public static extern ma_result ma_resource_manager_unregister_data_w(ma_resource_manager* pResourceManager, wchar_t* pName);
	
	/* Data Buffers. */
	[CLink] public static extern ma_result ma_resource_manager_data_buffer_init_ex(ma_resource_manager* pResourceManager, ma_resource_manager_data_source_config* pConfig, ma_resource_manager_data_buffer* pDataBuffer);
	[CLink] public static extern ma_result ma_resource_manager_data_buffer_init(ma_resource_manager* pResourceManager, char* pFilePath, ma_uint32 flags, ma_resource_manager_pipeline_notifications* pNotifications, ma_resource_manager_data_buffer* pDataBuffer);
	[CLink] public static extern ma_result ma_resource_manager_data_buffer_init_w(ma_resource_manager* pResourceManager, wchar_t* pFilePath, ma_uint32 flags, ma_resource_manager_pipeline_notifications* pNotifications, ma_resource_manager_data_buffer* pDataBuffer);
	[CLink] public static extern ma_result ma_resource_manager_data_buffer_init_copy(ma_resource_manager* pResourceManager, ma_resource_manager_data_buffer* pExistingDataBuffer, ma_resource_manager_data_buffer* pDataBuffer);
	[CLink] public static extern ma_result ma_resource_manager_data_buffer_uninit(ma_resource_manager_data_buffer* pDataBuffer);
	[CLink] public static extern ma_result ma_resource_manager_data_buffer_read_pcm_frames(ma_resource_manager_data_buffer* pDataBuffer, void* pFramesOut, ma_uint64 frameCount, ma_uint64* pFramesRead);
	[CLink] public static extern ma_result ma_resource_manager_data_buffer_seek_to_pcm_frame(ma_resource_manager_data_buffer* pDataBuffer, ma_uint64 frameIndex);
	[CLink] public static extern ma_result ma_resource_manager_data_buffer_get_data_format(ma_resource_manager_data_buffer* pDataBuffer, ma_format* pFormat, ma_uint32* pChannels, ma_uint32* pSampleRate, ma_channel* pChannelMap, size_t channelMapCap);
	[CLink] public static extern ma_result ma_resource_manager_data_buffer_get_cursor_in_pcm_frames(ma_resource_manager_data_buffer* pDataBuffer, ma_uint64* pCursor);
	[CLink] public static extern ma_result ma_resource_manager_data_buffer_get_length_in_pcm_frames(ma_resource_manager_data_buffer* pDataBuffer, ma_uint64* pLength);
	[CLink] public static extern ma_result ma_resource_manager_data_buffer_result(ma_resource_manager_data_buffer* pDataBuffer);
	[CLink] public static extern ma_result ma_resource_manager_data_buffer_set_looping(ma_resource_manager_data_buffer* pDataBuffer, ma_bool32 isLooping);
	[CLink] public static extern ma_bool32 ma_resource_manager_data_buffer_is_looping(ma_resource_manager_data_buffer* pDataBuffer);
	[CLink] public static extern ma_result ma_resource_manager_data_buffer_get_available_frames(ma_resource_manager_data_buffer* pDataBuffer, ma_uint64* pAvailableFrames);
	
	/* Data Streams. */
	[CLink] public static extern ma_result ma_resource_manager_data_stream_init_ex(ma_resource_manager* pResourceManager, ma_resource_manager_data_source_config* pConfig, ma_resource_manager_data_stream* pDataStream);
	[CLink] public static extern ma_result ma_resource_manager_data_stream_init(ma_resource_manager* pResourceManager, char* pFilePath, ma_uint32 flags, ma_resource_manager_pipeline_notifications* pNotifications, ma_resource_manager_data_stream* pDataStream);
	[CLink] public static extern ma_result ma_resource_manager_data_stream_init_w(ma_resource_manager* pResourceManager, wchar_t* pFilePath, ma_uint32 flags, ma_resource_manager_pipeline_notifications* pNotifications, ma_resource_manager_data_stream* pDataStream);
	[CLink] public static extern ma_result ma_resource_manager_data_stream_uninit(ma_resource_manager_data_stream* pDataStream);
	[CLink] public static extern ma_result ma_resource_manager_data_stream_read_pcm_frames(ma_resource_manager_data_stream* pDataStream, void* pFramesOut, ma_uint64 frameCount, ma_uint64* pFramesRead);
	[CLink] public static extern ma_result ma_resource_manager_data_stream_seek_to_pcm_frame(ma_resource_manager_data_stream* pDataStream, ma_uint64 frameIndex);
	[CLink] public static extern ma_result ma_resource_manager_data_stream_get_data_format(ma_resource_manager_data_stream* pDataStream, ma_format* pFormat, ma_uint32* pChannels, ma_uint32* pSampleRate, ma_channel* pChannelMap, size_t channelMapCap);
	[CLink] public static extern ma_result ma_resource_manager_data_stream_get_cursor_in_pcm_frames(ma_resource_manager_data_stream* pDataStream, ma_uint64* pCursor);
	[CLink] public static extern ma_result ma_resource_manager_data_stream_get_length_in_pcm_frames(ma_resource_manager_data_stream* pDataStream, ma_uint64* pLength);
	[CLink] public static extern ma_result ma_resource_manager_data_stream_result(ma_resource_manager_data_stream* pDataStream);
	[CLink] public static extern ma_result ma_resource_manager_data_stream_set_looping(ma_resource_manager_data_stream* pDataStream, ma_bool32 isLooping);
	[CLink] public static extern ma_bool32 ma_resource_manager_data_stream_is_looping(ma_resource_manager_data_stream* pDataStream);
	[CLink] public static extern ma_result ma_resource_manager_data_stream_get_available_frames(ma_resource_manager_data_stream* pDataStream, ma_uint64* pAvailableFrames);
	
	/* Data Sources. */
	[CLink] public static extern ma_result ma_resource_manager_data_source_init_ex(ma_resource_manager* pResourceManager, ma_resource_manager_data_source_config* pConfig, ma_resource_manager_data_source* pDataSource);
	[CLink] public static extern ma_result ma_resource_manager_data_source_init(ma_resource_manager* pResourceManager, char* pName, ma_uint32 flags, ma_resource_manager_pipeline_notifications* pNotifications, ma_resource_manager_data_source* pDataSource);
	[CLink] public static extern ma_result ma_resource_manager_data_source_init_w(ma_resource_manager* pResourceManager, wchar_t* pName, ma_uint32 flags, ma_resource_manager_pipeline_notifications* pNotifications, ma_resource_manager_data_source* pDataSource);
	[CLink] public static extern ma_result ma_resource_manager_data_source_init_copy(ma_resource_manager* pResourceManager, ma_resource_manager_data_source* pExistingDataSource, ma_resource_manager_data_source* pDataSource);
	[CLink] public static extern ma_result ma_resource_manager_data_source_uninit(ma_resource_manager_data_source* pDataSource);
	[CLink] public static extern ma_result ma_resource_manager_data_source_read_pcm_frames(ma_resource_manager_data_source* pDataSource, void* pFramesOut, ma_uint64 frameCount, ma_uint64* pFramesRead);
	[CLink] public static extern ma_result ma_resource_manager_data_source_seek_to_pcm_frame(ma_resource_manager_data_source* pDataSource, ma_uint64 frameIndex);
	[CLink] public static extern ma_result ma_resource_manager_data_source_get_data_format(ma_resource_manager_data_source* pDataSource, ma_format* pFormat, ma_uint32* pChannels, ma_uint32* pSampleRate, ma_channel* pChannelMap, size_t channelMapCap);
	[CLink] public static extern ma_result ma_resource_manager_data_source_get_cursor_in_pcm_frames(ma_resource_manager_data_source* pDataSource, ma_uint64* pCursor);
	[CLink] public static extern ma_result ma_resource_manager_data_source_get_length_in_pcm_frames(ma_resource_manager_data_source* pDataSource, ma_uint64* pLength);
	[CLink] public static extern ma_result ma_resource_manager_data_source_result(ma_resource_manager_data_source* pDataSource);
	[CLink] public static extern ma_result ma_resource_manager_data_source_set_looping(ma_resource_manager_data_source* pDataSource, ma_bool32 isLooping);
	[CLink] public static extern ma_bool32 ma_resource_manager_data_source_is_looping(ma_resource_manager_data_source* pDataSource);
	[CLink] public static extern ma_result ma_resource_manager_data_source_get_available_frames(ma_resource_manager_data_source* pDataSource, ma_uint64* pAvailableFrames);
	
	/* Job management. */
	[CLink] public static extern ma_result ma_resource_manager_post_job(ma_resource_manager* pResourceManager, ma_job* pJob);
	[CLink] public static extern ma_result ma_resource_manager_post_job_quit(ma_resource_manager* pResourceManager);  /* Helper for posting a quit job. */
	[CLink] public static extern ma_result ma_resource_manager_next_job(ma_resource_manager* pResourceManager, ma_job* pJob);
	[CLink] public static extern ma_result ma_resource_manager_process_job(ma_resource_manager* pResourceManager, ma_job* pJob);  /* DEPRECATED. Use ma_job_process(). Will be removed in version 0.12. */
	[CLink] public static extern ma_result ma_resource_manager_process_next_job(ma_resource_manager* pResourceManager);   /* Returns MA_CANCELLED if a MA_JOB_TYPE_QUIT job is found. In non-blocking mode, returns MA_NO_DATA_AVAILABLE if no jobs are available. */
	...
	************************************************************************************************************************************************************/
	...
	#if !MA_MAX_NODE_BUS_COUNT
	const c_int MA_MAX_NODE_BUS_COUNT       = 254;
	#endif
	
	/* Used internally by miniaudio for memory management. Must never exceed MA_MAX_NODE_BUS_COUNT. */
	#if !MA_MAX_NODE_LOCAL_BUS_COUNT
	const c_int MA_MAX_NODE_LOCAL_BUS_COUNT = 2;
	#endif
	
	/* Use this when the bus count is determined by the node instance rather than the vtable. */
	const c_int MA_NODE_BUS_COUNT_UNKNOWN   = 255;

	public typealias ma_node = void;
	
	/* Node flags. */
	public enum ma_node_flags : c_int
	{
	...
	public enum ma_node_state : c_int
	{
	...
	public struct ma_node_vtable
	{
	    ...
	    */
	    function void(ma_node* pNode, float** ppFramesIn, ma_uint32* pFrameCountIn, float** ppFramesOut, ma_uint32* pFrameCountOut) onProcess;
	    ...
	    */
	    function ma_result(ma_node* pNode, ma_uint32 outputFrameCount, ma_uint32* pInputFrameCount) onGetRequiredInputFrameCount;
	...
	{
	    ma_node_vtable* vtable;       /* Should never be null. Initialization of the node will fail if so. */
	    ...
	    ma_uint32* pInputChannels;    /* The number of elements are determined by the input bus count as determined by the vtable, or `inputBusCount` if the vtable specifies `MA_NODE_BUS_COUNT_UNKNOWN`. */
	    ma_uint32* pOutputChannels;   /* The number of elements are determined by the output bus count as determined by the vtable, or `outputBusCount` if the vtable specifies `MA_NODE_BUS_COUNT_UNKNOWN`. */
	}
	
	[CLink] public static extern ma_node_config ma_node_config_init();
	...
	*/
	...
	public struct ma_node_base
	{
	    ...
	    /* Memory management. */
	    ma_node_input_bus[MA_MAX_NODE_LOCAL_BUS_COUNT] _inputBuses;
	    ma_node_output_bus[MA_MAX_NODE_LOCAL_BUS_COUNT] _outputBuses;
	...
	[CLink] public static extern ma_result ma_node_get_heap_size(ma_node_graph* pNodeGraph, ma_node_config* pConfig, size_t* pHeapSizeInBytes);
	[CLink] public static extern ma_result ma_node_init_preallocated(ma_node_graph* pNodeGraph, ma_node_config* pConfig, void* pHeap, ma_node* pNode);
	[CLink] public static extern ma_result ma_node_init(ma_node_graph* pNodeGraph, ma_node_config* pConfig, ma_allocation_callbacks* pAllocationCallbacks, ma_node* pNode);
	[CLink] public static extern void ma_node_uninit(ma_node* pNode, ma_allocation_callbacks* pAllocationCallbacks);
	[CLink] public static extern ma_node_graph* ma_node_get_node_graph(ma_node* pNode);
	[CLink] public static extern ma_uint32 ma_node_get_input_bus_count(ma_node* pNode);
	[CLink] public static extern ma_uint32 ma_node_get_output_bus_count(ma_node* pNode);
	[CLink] public static extern ma_uint32 ma_node_get_input_channels(ma_node* pNode, ma_uint32 inputBusIndex);
	[CLink] public static extern ma_uint32 ma_node_get_output_channels(ma_node* pNode, ma_uint32 outputBusIndex);
	[CLink] public static extern ma_result ma_node_attach_output_bus(ma_node* pNode, ma_uint32 outputBusIndex, ma_node* pOtherNode, ma_uint32 otherNodeInputBusIndex);
	[CLink] public static extern ma_result ma_node_detach_output_bus(ma_node* pNode, ma_uint32 outputBusIndex);
	[CLink] public static extern ma_result ma_node_detach_all_output_buses(ma_node* pNode);
	[CLink] public static extern ma_result ma_node_set_output_bus_volume(ma_node* pNode, ma_uint32 outputBusIndex, float volume);
	[CLink] public static extern float ma_node_get_output_bus_volume(ma_node* pNode, ma_uint32 outputBusIndex);
	[CLink] public static extern ma_result ma_node_set_state(ma_node* pNode, ma_node_state state);
	[CLink] public static extern ma_node_state ma_node_get_state(ma_node* pNode);
	[CLink] public static extern ma_result ma_node_set_state_time(ma_node* pNode, ma_node_state state, ma_uint64 globalTime);
	[CLink] public static extern ma_uint64 ma_node_get_state_time(ma_node* pNode, ma_node_state state);
	[CLink] public static extern ma_node_state ma_node_get_state_by_time(ma_node* pNode, ma_uint64 globalTime);
	[CLink] public static extern ma_node_state ma_node_get_state_by_time_range(ma_node* pNode, ma_uint64 globalTimeBeg, ma_uint64 globalTimeEnd);
	[CLink] public static extern ma_uint64 ma_node_get_time(ma_node* pNode);
	[CLink] public static extern ma_result ma_node_set_time(ma_node* pNode, ma_uint64 localTime);
	...
	[CLink] public static extern ma_node_graph_config ma_node_graph_config_init(ma_uint32 channels);
	
	[CRepr]
	public struct ma_node_graph
	{
	    /* Immutable. */
	    ma_node_base baseNode;                  /* The node graph itself is a node so it can be connected as an input to different node graph. This has zero inputs and calls ma_node_graph_read_pcm_frames() to generate it's output. */
	...
	[CLink] public static extern ma_result ma_node_graph_init(ma_node_graph_config* pConfig, ma_allocation_callbacks* pAllocationCallbacks, ma_node_graph* pNodeGraph);
	[CLink] public static extern void ma_node_graph_uninit(ma_node_graph* pNodeGraph, ma_allocation_callbacks* pAllocationCallbacks);
	[CLink] public static extern ma_node* ma_node_graph_get_endpoint(ma_node_graph* pNodeGraph);
	[CLink] public static extern ma_result ma_node_graph_read_pcm_frames(ma_node_graph* pNodeGraph, void* pFramesOut, ma_uint64 frameCount, ma_uint64* pFramesRead);
	[CLink] public static extern ma_uint32 ma_node_graph_get_channels(ma_node_graph* pNodeGraph);
	[CLink] public static extern ma_uint64 ma_node_graph_get_time(ma_node_graph* pNodeGraph);
	[CLink] public static extern ma_result ma_node_graph_set_time(ma_node_graph* pNodeGraph, ma_uint64 globalTime);
	...
	[CLink] public static extern ma_data_source_node_config ma_data_source_node_config_init(ma_data_source* pDataSource);
	...
	[CLink] public static extern ma_result ma_data_source_node_init(ma_node_graph* pNodeGraph, ma_data_source_node_config* pConfig, ma_allocation_callbacks* pAllocationCallbacks, ma_data_source_node* pDataSourceNode);
	[CLink] public static extern void ma_data_source_node_uninit(ma_data_source_node* pDataSourceNode, ma_allocation_callbacks* pAllocationCallbacks);
	[CLink] public static extern ma_result ma_data_source_node_set_looping(ma_data_source_node* pDataSourceNode, ma_bool32 isLooping);
	[CLink] public static extern ma_bool32 ma_data_source_node_is_looping(ma_data_source_node* pDataSourceNode);
	...
	[CLink] public static extern ma_splitter_node_config ma_splitter_node_config_init(ma_uint32 channels);
	...
	[CLink] public static extern ma_result ma_splitter_node_init(ma_node_graph* pNodeGraph, ma_splitter_node_config* pConfig, ma_allocation_callbacks* pAllocationCallbacks, ma_splitter_node* pSplitterNode);
	[CLink] public static extern void ma_splitter_node_uninit(ma_splitter_node* pSplitterNode, ma_allocation_callbacks* pAllocationCallbacks);
	...
	*/
	...
	[CLink] public static extern ma_biquad_node_config ma_biquad_node_config_init(ma_uint32 channels, float b0, float b1, float b2, float a0, float a1, float a2);
	...
	[CLink] public static extern ma_result ma_biquad_node_init(ma_node_graph* pNodeGraph, ma_biquad_node_config* pConfig, ma_allocation_callbacks* pAllocationCallbacks, ma_biquad_node* pNode);
	[CLink] public static extern ma_result ma_biquad_node_reinit(ma_biquad_config* pConfig, ma_biquad_node* pNode);
	[CLink] public static extern void ma_biquad_node_uninit(ma_biquad_node* pNode, ma_allocation_callbacks* pAllocationCallbacks);
	...
	*/
	...
	[CLink] public static extern ma_lpf_node_config ma_lpf_node_config_init(ma_uint32 channels, ma_uint32 sampleRate, double cutoffFrequency, ma_uint32 order);
	...
	[CLink] public static extern ma_result ma_lpf_node_init(ma_node_graph* pNodeGraph, ma_lpf_node_config* pConfig, ma_allocation_callbacks* pAllocationCallbacks, ma_lpf_node* pNode);
	[CLink] public static extern ma_result ma_lpf_node_reinit(ma_lpf_config* pConfig, ma_lpf_node* pNode);
	[CLink] public static extern void ma_lpf_node_uninit(ma_lpf_node* pNode, ma_allocation_callbacks* pAllocationCallbacks);
	...
	*/
	...
	[CLink] public static extern ma_hpf_node_config ma_hpf_node_config_init(ma_uint32 channels, ma_uint32 sampleRate, double cutoffFrequency, ma_uint32 order);
	...
	[CLink] public static extern ma_result ma_hpf_node_init(ma_node_graph* pNodeGraph, ma_hpf_node_config* pConfig, ma_allocation_callbacks* pAllocationCallbacks, ma_hpf_node* pNode);
	[CLink] public static extern ma_result ma_hpf_node_reinit(ma_hpf_config* pConfig, ma_hpf_node* pNode);
	[CLink] public static extern void ma_hpf_node_uninit(ma_hpf_node* pNode, ma_allocation_callbacks* pAllocationCallbacks);
	...
	*/
	...
	[CLink] public static extern ma_bpf_node_config ma_bpf_node_config_init(ma_uint32 channels, ma_uint32 sampleRate, double cutoffFrequency, ma_uint32 order);
	...
	[CLink] public static extern ma_result ma_bpf_node_init(ma_node_graph* pNodeGraph, ma_bpf_node_config* pConfig, ma_allocation_callbacks* pAllocationCallbacks, ma_bpf_node* pNode);
	[CLink] public static extern ma_result ma_bpf_node_reinit(ma_bpf_config* pConfig, ma_bpf_node* pNode);
	[CLink] public static extern void ma_bpf_node_uninit(ma_bpf_node* pNode, ma_allocation_callbacks* pAllocationCallbacks);
	...
	*/
	...
	[CLink] public static extern ma_notch_node_config ma_notch_node_config_init(ma_uint32 channels, ma_uint32 sampleRate, double q, double frequency);
	...
	[CLink] public static extern ma_result ma_notch_node_init(ma_node_graph* pNodeGraph, ma_notch_node_config* pConfig, ma_allocation_callbacks* pAllocationCallbacks, ma_notch_node* pNode);
	[CLink] public static extern ma_result ma_notch_node_reinit(ma_notch_config* pConfig, ma_notch_node* pNode);
	[CLink] public static extern void ma_notch_node_uninit(ma_notch_node* pNode, ma_allocation_callbacks* pAllocationCallbacks);
	...
	*/
	...
	[CLink] public static extern ma_peak_node_config ma_peak_node_config_init(ma_uint32 channels, ma_uint32 sampleRate, double gainDB, double q, double frequency);
	...
	[CLink] public static extern ma_result ma_peak_node_init(ma_node_graph* pNodeGraph, ma_peak_node_config* pConfig, ma_allocation_callbacks* pAllocationCallbacks, ma_peak_node* pNode);
	[CLink] public static extern ma_result ma_peak_node_reinit(ma_peak_config* pConfig, ma_peak_node* pNode);
	[CLink] public static extern void ma_peak_node_uninit(ma_peak_node* pNode, ma_allocation_callbacks* pAllocationCallbacks);
	...
	*/
	...
	[CLink] public static extern ma_loshelf_node_config ma_loshelf_node_config_init(ma_uint32 channels, ma_uint32 sampleRate, double gainDB, double q, double frequency);
	...
	[CLink] public static extern ma_result ma_loshelf_node_init(ma_node_graph* pNodeGraph, ma_loshelf_node_config* pConfig, ma_allocation_callbacks* pAllocationCallbacks, ma_loshelf_node* pNode);
	[CLink] public static extern ma_result ma_loshelf_node_reinit(ma_loshelf_config* pConfig, ma_loshelf_node* pNode);
	[CLink] public static extern void ma_loshelf_node_uninit(ma_loshelf_node* pNode, ma_allocation_callbacks* pAllocationCallbacks);
	...
	*/
	...
	[CLink] public static extern ma_hishelf_node_config ma_hishelf_node_config_init(ma_uint32 channels, ma_uint32 sampleRate, double gainDB, double q, double frequency);
	...
	[CLink] public static extern ma_result ma_hishelf_node_init(ma_node_graph* pNodeGraph, ma_hishelf_node_config* pConfig, ma_allocation_callbacks* pAllocationCallbacks, ma_hishelf_node* pNode);
	[CLink] public static extern ma_result ma_hishelf_node_reinit(ma_hishelf_config* pConfig, ma_hishelf_node* pNode);
	[CLink] public static extern void ma_hishelf_node_uninit(ma_hishelf_node* pNode, ma_allocation_callbacks* pAllocationCallbacks);
	...
	[CLink] public static extern ma_delay_node_config ma_delay_node_config_init(ma_uint32 channels, ma_uint32 sampleRate, ma_uint32 delayInFrames, float decay);
	...
	[CLink] public static extern ma_result ma_delay_node_init(ma_node_graph* pNodeGraph, ma_delay_node_config* pConfig, ma_allocation_callbacks* pAllocationCallbacks, ma_delay_node* pDelayNode);
	[CLink] public static extern void ma_delay_node_uninit(ma_delay_node* pDelayNode, ma_allocation_callbacks* pAllocationCallbacks);
	[CLink] public static extern void ma_delay_node_set_wet(ma_delay_node* pDelayNode, float value);
	[CLink] public static extern  float ma_delay_node_get_wet(ma_delay_node* pDelayNode);
	[CLink] public static extern void ma_delay_node_set_dry(ma_delay_node* pDelayNode, float value);
	[CLink] public static extern  float ma_delay_node_get_dry(ma_delay_node* pDelayNode);
	[CLink] public static extern void ma_delay_node_set_decay(ma_delay_node* pDelayNode, float value);
	[CLink] public static extern  float ma_delay_node_get_decay(ma_delay_node* pDelayNode);
	...
	************************************************************************************************************************************************************/
#if !MA_NO_ENGINE && !MA_NO_NODE_GRAPH
	// [CRepr]
	...
	/* Sound flags. */
	public enum ma_sound_flags : c_int
	{
	...
	#if !MA_ENGINE_MAX_LISTENERS
		const c_int MA_ENGINE_MAX_LISTENERS 			= 4;
	#endif
	
	const c_int MA_LISTENER_INDEX_CLOSEST           	= ((ma_uint8)-1);
	
	public enum ma_engine_node_type : c_int
	{
	...
	[CLink] public static extern  ma_engine_node_config ma_engine_node_config_init(ma_engine* pEngine, ma_engine_node_type type, ma_uint32 flags);
	...
	[CLink] public static extern ma_result ma_engine_node_get_heap_size(ma_engine_node_config* pConfig, size_t* pHeapSizeInBytes);
	[CLink] public static extern ma_result ma_engine_node_init_preallocated(ma_engine_node_config* pConfig, void* pHeap, ma_engine_node* pEngineNode);
	[CLink] public static extern ma_result ma_engine_node_init(ma_engine_node_config* pConfig, ma_allocation_callbacks* pAllocationCallbacks, ma_engine_node* pEngineNode);
	[CLink] public static extern void ma_engine_node_uninit(ma_engine_node* pEngineNode, ma_allocation_callbacks* pAllocationCallbacks);
	
	const c_int MA_SOUND_SOURCE_CHANNEL_COUNT = (.)0xFFFFFFFF;
	
	/* Callback for when a sound reaches the end. */
	function void ma_sound_end_proc(void* pUserData, ma_sound* pSound);
	
	[CRepr]
	public struct ma_sound_config
	{
	    char* pFilePath;                      /* Set this to load from the resource manager. */
	    wchar_t* pFilePathW;                  /* Set this to load from the resource manager. */
	...
	[CLink] public static extern ma_sound_config ma_sound_config_init();                  /* Deprecated. Will be removed in version 0.12. Use ma_sound_config_2() instead. */
	[CLink] public static extern ma_sound_config ma_sound_config_init_2(ma_engine* pEngine);  /* Will be renamed to ma_sound_config_init() in version 0.12. */
	...
	typealias ma_sound_group_config = ma_sound_config;
	typealias ma_sound_group = ma_sound       ;
	
	[CLink] public static extern ma_sound_group_config ma_sound_group_config_init();                  /* Deprecated. Will be removed in version 0.12. Use ma_sound_config_2() instead. */
	[CLink] public static extern ma_sound_group_config ma_sound_group_config_init_2(ma_engine* pEngine);  /* Will be renamed to ma_sound_config_init() in version 0.12. */
	
	function void ma_engine_process_proc(void* pUserData, float* pFramesOut, ma_uint64 frameCount);
	...
	[CLink] public static extern ma_engine_config ma_engine_config_init();
	...
	public struct ma_engine
	{
	    ...
	    ma_spatializer_listener[MA_ENGINE_MAX_LISTENERS] listeners;
	    ma_allocation_callbacks allocationCallbacks;
	...
	[CLink] public static extern ma_result ma_engine_init(ma_engine_config* pConfig, ma_engine* pEngine);
	[CLink] public static extern void ma_engine_uninit(ma_engine* pEngine);
	[CLink] public static extern ma_result ma_engine_read_pcm_frames(ma_engine* pEngine, void* pFramesOut, ma_uint64 frameCount, ma_uint64* pFramesRead);
	[CLink] public static extern ma_node_graph* ma_engine_get_node_graph(ma_engine* pEngine);

#if !MA_NO_RESOURCE_MANAGER
	[CLink] public static extern ma_resource_manager* ma_engine_get_resource_manager(ma_engine* pEngine);
#endif

	[CLink] public static extern ma_device* ma_engine_get_device(ma_engine* pEngine);
	[CLink] public static extern ma_log* ma_engine_get_log(ma_engine* pEngine);
	[CLink] public static extern ma_node* ma_engine_get_endpoint(ma_engine* pEngine);
	[CLink] public static extern ma_uint64 ma_engine_get_time_in_pcm_frames(ma_engine* pEngine);
	[CLink] public static extern ma_uint64 ma_engine_get_time_in_milliseconds(ma_engine* pEngine);
	[CLink] public static extern ma_result ma_engine_set_time_in_pcm_frames(ma_engine* pEngine, ma_uint64 globalTime);
	[CLink] public static extern ma_result ma_engine_set_time_in_milliseconds(ma_engine* pEngine, ma_uint64 globalTime);
	[CLink] public static extern ma_uint64 ma_engine_get_time(ma_engine* pEngine);                  /* Deprecated. Use ma_engine_get_time_in_pcm_frames(). Will be removed in version 0.12. */
	[CLink] public static extern ma_result ma_engine_set_time(ma_engine* pEngine, ma_uint64 globalTime);  /* Deprecated. Use ma_engine_set_time_in_pcm_frames(). Will be removed in version 0.12. */
	[CLink] public static extern ma_uint32 ma_engine_get_channels(ma_engine* pEngine);
	[CLink] public static extern ma_uint32 ma_engine_get_sample_rate(ma_engine* pEngine);
	
	[CLink] public static extern ma_result ma_engine_start(ma_engine* pEngine);
	[CLink] public static extern ma_result ma_engine_stop(ma_engine* pEngine);
	[CLink] public static extern ma_result ma_engine_set_volume(ma_engine* pEngine, float volume);
	[CLink] public static extern float ma_engine_get_volume(ma_engine* pEngine);
	[CLink] public static extern ma_result ma_engine_set_gain_db(ma_engine* pEngine, float gainDB);
	[CLink] public static extern float ma_engine_get_gain_db(ma_engine* pEngine);
	
	[CLink] public static extern ma_uint32 ma_engine_get_listener_count(ma_engine* pEngine);
	[CLink] public static extern ma_uint32 ma_engine_find_closest_listener(ma_engine* pEngine, float absolutePosX, float absolutePosY, float absolutePosZ);
	[CLink] public static extern void ma_engine_listener_set_position(ma_engine* pEngine, ma_uint32 listenerIndex, float x, float y, float z);
	[CLink] public static extern ma_vec3f ma_engine_listener_get_position(ma_engine* pEngine, ma_uint32 listenerIndex);
	[CLink] public static extern void ma_engine_listener_set_direction(ma_engine* pEngine, ma_uint32 listenerIndex, float x, float y, float z);
	[CLink] public static extern ma_vec3f ma_engine_listener_get_direction(ma_engine* pEngine, ma_uint32 listenerIndex);
	[CLink] public static extern void ma_engine_listener_set_velocity(ma_engine* pEngine, ma_uint32 listenerIndex, float x, float y, float z);
	[CLink] public static extern ma_vec3f ma_engine_listener_get_velocity(ma_engine* pEngine, ma_uint32 listenerIndex);
	[CLink] public static extern void ma_engine_listener_set_cone(ma_engine* pEngine, ma_uint32 listenerIndex, float innerAngleInRadians, float outerAngleInRadians, float outerGain);
	[CLink] public static extern void ma_engine_listener_get_cone(ma_engine* pEngine, ma_uint32 listenerIndex, float* pInnerAngleInRadians, float* pOuterAngleInRadians, float* pOuterGain);
	[CLink] public static extern void ma_engine_listener_set_world_up(ma_engine* pEngine, ma_uint32 listenerIndex, float x, float y, float z);
	[CLink] public static extern ma_vec3f ma_engine_listener_get_world_up(ma_engine* pEngine, ma_uint32 listenerIndex);
	[CLink] public static extern void ma_engine_listener_set_enabled(ma_engine* pEngine, ma_uint32 listenerIndex, ma_bool32 isEnabled);
	[CLink] public static extern ma_bool32 ma_engine_listener_is_enabled(ma_engine* pEngine, ma_uint32 listenerIndex);

#if !MA_NO_RESOURCE_MANAGER
    [CLink] public static extern ma_result ma_engine_play_sound_ex(ma_engine* pEngine, char* pFilePath, ma_node* pNode, ma_uint32 nodeInputBusIndex);
    [CLink] public static extern ma_result ma_engine_play_sound(ma_engine* pEngine, char* pFilePath, ma_sound_group* pGroup);   /* Fire and forget. */
#endif

#if !MA_NO_RESOURCE_MANAGER
    [CLink] public static extern ma_result ma_sound_init_from_file(ma_engine* pEngine, char* pFilePath, ma_uint32 flags, ma_sound_group* pGroup, ma_fence* pDoneFence, ma_sound* pSound);
    [CLink] public static extern ma_result ma_sound_init_from_file_w(ma_engine* pEngine, wchar_t* pFilePath, ma_uint32 flags, ma_sound_group* pGroup, ma_fence* pDoneFence, ma_sound* pSound);
    [CLink] public static extern ma_result ma_sound_init_copy(ma_engine* pEngine, ma_sound* pExistingSound, ma_uint32 flags, ma_sound_group* pGroup, ma_sound* pSound);
#endif

    [CLink] public static extern ma_result ma_sound_init_from_data_source(ma_engine* pEngine, ma_data_source* pDataSource, ma_uint32 flags, ma_sound_group* pGroup, ma_sound* pSound);
    [CLink] public static extern ma_result ma_sound_init_ex(ma_engine* pEngine, ma_sound_config* pConfig, ma_sound* pSound);
    [CLink] public static extern void ma_sound_uninit(ma_sound* pSound);
    [CLink] public static extern ma_engine* ma_sound_get_engine(ma_sound* pSound);
    [CLink] public static extern ma_data_source* ma_sound_get_data_source(ma_sound* pSound);
    [CLink] public static extern ma_result ma_sound_start(ma_sound* pSound);
    [CLink] public static extern ma_result ma_sound_stop(ma_sound* pSound);
    [CLink] public static extern ma_result ma_sound_stop_with_fade_in_pcm_frames(ma_sound* pSound, ma_uint64 fadeLengthInFrames);     /* Will overwrite any scheduled stop and fade. */
    [CLink] public static extern ma_result ma_sound_stop_with_fade_in_milliseconds(ma_sound* pSound, ma_uint64 fadeLengthInFrames);   /* Will overwrite any scheduled stop and fade. */
    [CLink] public static extern void ma_sound_set_volume(ma_sound* pSound, float volume);
    [CLink] public static extern float ma_sound_get_volume(ma_sound* pSound);
    [CLink] public static extern void ma_sound_set_pan(ma_sound* pSound, float pan);
    [CLink] public static extern float ma_sound_get_pan(ma_sound* pSound);
    [CLink] public static extern void ma_sound_set_pan_mode(ma_sound* pSound, ma_pan_mode panMode);
    [CLink] public static extern ma_pan_mode ma_sound_get_pan_mode(ma_sound* pSound);
    [CLink] public static extern void ma_sound_set_pitch(ma_sound* pSound, float pitch);
    [CLink] public static extern float ma_sound_get_pitch(ma_sound* pSound);
    [CLink] public static extern void ma_sound_set_spatialization_enabled(ma_sound* pSound, ma_bool32 enabled);
    [CLink] public static extern ma_bool32 ma_sound_is_spatialization_enabled(ma_sound* pSound);
    [CLink] public static extern void ma_sound_set_pinned_listener_index(ma_sound* pSound, ma_uint32 listenerIndex);
    [CLink] public static extern ma_uint32 ma_sound_get_pinned_listener_index(ma_sound* pSound);
    [CLink] public static extern ma_uint32 ma_sound_get_listener_index(ma_sound* pSound);
    [CLink] public static extern ma_vec3f ma_sound_get_direction_to_listener(ma_sound* pSound);
    [CLink] public static extern void ma_sound_set_position(ma_sound* pSound, float x, float y, float z);
    [CLink] public static extern ma_vec3f ma_sound_get_position(ma_sound* pSound);
    [CLink] public static extern void ma_sound_set_direction(ma_sound* pSound, float x, float y, float z);
    [CLink] public static extern ma_vec3f ma_sound_get_direction(ma_sound* pSound);
    [CLink] public static extern void ma_sound_set_velocity(ma_sound* pSound, float x, float y, float z);
    [CLink] public static extern ma_vec3f ma_sound_get_velocity(ma_sound* pSound);
    [CLink] public static extern void ma_sound_set_attenuation_model(ma_sound* pSound, ma_attenuation_model attenuationModel);
    [CLink] public static extern ma_attenuation_model ma_sound_get_attenuation_model(ma_sound* pSound);
    [CLink] public static extern void ma_sound_set_positioning(ma_sound* pSound, ma_positioning positioning);
    [CLink] public static extern ma_positioning ma_sound_get_positioning(ma_sound* pSound);
    [CLink] public static extern void ma_sound_set_rolloff(ma_sound* pSound, float rolloff);
    [CLink] public static extern float ma_sound_get_rolloff(ma_sound* pSound);
    [CLink] public static extern void ma_sound_set_min_gain(ma_sound* pSound, float minGain);
    [CLink] public static extern float ma_sound_get_min_gain(ma_sound* pSound);
    [CLink] public static extern void ma_sound_set_max_gain(ma_sound* pSound, float maxGain);
    [CLink] public static extern float ma_sound_get_max_gain(ma_sound* pSound);
    [CLink] public static extern void ma_sound_set_min_distance(ma_sound* pSound, float minDistance);
    [CLink] public static extern float ma_sound_get_min_distance(ma_sound* pSound);
    [CLink] public static extern void ma_sound_set_max_distance(ma_sound* pSound, float maxDistance);
    [CLink] public static extern float ma_sound_get_max_distance(ma_sound* pSound);
    [CLink] public static extern void ma_sound_set_cone(ma_sound* pSound, float innerAngleInRadians, float outerAngleInRadians, float outerGain);
    [CLink] public static extern void ma_sound_get_cone(ma_sound* pSound, float* pInnerAngleInRadians, float* pOuterAngleInRadians, float* pOuterGain);
    [CLink] public static extern void ma_sound_set_doppler_factor(ma_sound* pSound, float dopplerFactor);
    [CLink] public static extern float ma_sound_get_doppler_factor(ma_sound* pSound);
    [CLink] public static extern void ma_sound_set_directional_attenuation_factor(ma_sound* pSound, float directionalAttenuationFactor);
    [CLink] public static extern float ma_sound_get_directional_attenuation_factor(ma_sound* pSound);
    [CLink] public static extern void ma_sound_set_fade_in_pcm_frames(ma_sound* pSound, float volumeBeg, float volumeEnd, ma_uint64 fadeLengthInFrames);
    [CLink] public static extern void ma_sound_set_fade_in_milliseconds(ma_sound* pSound, float volumeBeg, float volumeEnd, ma_uint64 fadeLengthInMilliseconds);
    [CLink] public static extern void ma_sound_set_fade_start_in_pcm_frames(ma_sound* pSound, float volumeBeg, float volumeEnd, ma_uint64 fadeLengthInFrames, ma_uint64 absoluteGlobalTimeInFrames);
    [CLink] public static extern void ma_sound_set_fade_start_in_milliseconds(ma_sound* pSound, float volumeBeg, float volumeEnd, ma_uint64 fadeLengthInMilliseconds, ma_uint64 absoluteGlobalTimeInMilliseconds);
    [CLink] public static extern float ma_sound_get_current_fade_volume(ma_sound* pSound);
    [CLink] public static extern void ma_sound_set_start_time_in_pcm_frames(ma_sound* pSound, ma_uint64 absoluteGlobalTimeInFrames);
    [CLink] public static extern void ma_sound_set_start_time_in_milliseconds(ma_sound* pSound, ma_uint64 absoluteGlobalTimeInMilliseconds);
    [CLink] public static extern void ma_sound_set_stop_time_in_pcm_frames(ma_sound* pSound, ma_uint64 absoluteGlobalTimeInFrames);
    [CLink] public static extern void ma_sound_set_stop_time_in_milliseconds(ma_sound* pSound, ma_uint64 absoluteGlobalTimeInMilliseconds);
    [CLink] public static extern void ma_sound_set_stop_time_with_fade_in_pcm_frames(ma_sound* pSound, ma_uint64 stopAbsoluteGlobalTimeInFrames, ma_uint64 fadeLengthInFrames);
    [CLink] public static extern void ma_sound_set_stop_time_with_fade_in_milliseconds(ma_sound* pSound, ma_uint64 stopAbsoluteGlobalTimeInMilliseconds, ma_uint64 fadeLengthInMilliseconds);
    [CLink] public static extern ma_bool32 ma_sound_is_playing(ma_sound* pSound);
    [CLink] public static extern ma_uint64 ma_sound_get_time_in_pcm_frames(ma_sound* pSound);
    [CLink] public static extern ma_uint64 ma_sound_get_time_in_milliseconds(ma_sound* pSound);
    [CLink] public static extern void ma_sound_set_looping(ma_sound* pSound, ma_bool32 isLooping);
    [CLink] public static extern ma_bool32 ma_sound_is_looping(ma_sound* pSound);
    [CLink] public static extern ma_bool32 ma_sound_at_end(ma_sound* pSound);
    [CLink] public static extern ma_result ma_sound_seek_to_pcm_frame(ma_sound* pSound, ma_uint64 frameIndex); /* Just a wrapper around ma_data_source_seek_to_pcm_frame(). */
    [CLink] public static extern ma_result ma_sound_get_data_format(ma_sound* pSound, ma_format* pFormat, ma_uint32* pChannels, ma_uint32* pSampleRate, ma_channel* pChannelMap, size_t channelMapCap);
    [CLink] public static extern ma_result ma_sound_get_cursor_in_pcm_frames(ma_sound* pSound, ma_uint64* pCursor);
    [CLink] public static extern ma_result ma_sound_get_length_in_pcm_frames(ma_sound* pSound, ma_uint64* pLength);
    [CLink] public static extern ma_result ma_sound_get_cursor_in_seconds(ma_sound* pSound, float* pCursor);
    [CLink] public static extern ma_result ma_sound_get_length_in_seconds(ma_sound* pSound, float* pLength);
    [CLink] public static extern ma_result ma_sound_set_end_callback(ma_sound* pSound, ma_sound_end_proc callback, void* pUserData);

    [CLink] public static extern ma_result ma_sound_group_init(ma_engine* pEngine, ma_uint32 flags, ma_sound_group* pParentGroup, ma_sound_group* pGroup);
    [CLink] public static extern ma_result ma_sound_group_init_ex(ma_engine* pEngine, ma_sound_group_config* pConfig, ma_sound_group* pGroup);
    [CLink] public static extern void ma_sound_group_uninit(ma_sound_group* pGroup);
    [CLink] public static extern ma_engine* ma_sound_group_get_engine(ma_sound_group* pGroup);
    [CLink] public static extern ma_result ma_sound_group_start(ma_sound_group* pGroup);
    [CLink] public static extern ma_result ma_sound_group_stop(ma_sound_group* pGroup);
    [CLink] public static extern void ma_sound_group_set_volume(ma_sound_group* pGroup, float volume);
    [CLink] public static extern float ma_sound_group_get_volume(ma_sound_group* pGroup);
    [CLink] public static extern void ma_sound_group_set_pan(ma_sound_group* pGroup, float pan);
    [CLink] public static extern float ma_sound_group_get_pan(ma_sound_group* pGroup);
    [CLink] public static extern void ma_sound_group_set_pan_mode(ma_sound_group* pGroup, ma_pan_mode panMode);
    [CLink] public static extern ma_pan_mode ma_sound_group_get_pan_mode(ma_sound_group* pGroup);
    [CLink] public static extern void ma_sound_group_set_pitch(ma_sound_group* pGroup, float pitch);
    [CLink] public static extern float ma_sound_group_get_pitch(ma_sound_group* pGroup);
    [CLink] public static extern void ma_sound_group_set_spatialization_enabled(ma_sound_group* pGroup, ma_bool32 enabled);
    [CLink] public static extern ma_bool32 ma_sound_group_is_spatialization_enabled(ma_sound_group* pGroup);
    [CLink] public static extern void ma_sound_group_set_pinned_listener_index(ma_sound_group* pGroup, ma_uint32 listenerIndex);
    [CLink] public static extern ma_uint32 ma_sound_group_get_pinned_listener_index(ma_sound_group* pGroup);
    [CLink] public static extern ma_uint32 ma_sound_group_get_listener_index(ma_sound_group* pGroup);
    [CLink] public static extern ma_vec3f ma_sound_group_get_direction_to_listener(ma_sound_group* pGroup);
    [CLink] public static extern void ma_sound_group_set_position(ma_sound_group* pGroup, float x, float y, float z);
    [CLink] public static extern ma_vec3f ma_sound_group_get_position(ma_sound_group* pGroup);
    [CLink] public static extern void ma_sound_group_set_direction(ma_sound_group* pGroup, float x, float y, float z);
    [CLink] public static extern ma_vec3f ma_sound_group_get_direction(ma_sound_group* pGroup);
    [CLink] public static extern void ma_sound_group_set_velocity(ma_sound_group* pGroup, float x, float y, float z);
    [CLink] public static extern ma_vec3f ma_sound_group_get_velocity(ma_sound_group* pGroup);
    [CLink] public static extern void ma_sound_group_set_attenuation_model(ma_sound_group* pGroup, ma_attenuation_model attenuationModel);
    [CLink] public static extern ma_attenuation_model ma_sound_group_get_attenuation_model(ma_sound_group* pGroup);
    [CLink] public static extern void ma_sound_group_set_positioning(ma_sound_group* pGroup, ma_positioning positioning);
    [CLink] public static extern ma_positioning ma_sound_group_get_positioning(ma_sound_group* pGroup);
    [CLink] public static extern void ma_sound_group_set_rolloff(ma_sound_group* pGroup, float rolloff);
    [CLink] public static extern float ma_sound_group_get_rolloff(ma_sound_group* pGroup);
    [CLink] public static extern void ma_sound_group_set_min_gain(ma_sound_group* pGroup, float minGain);
    [CLink] public static extern float ma_sound_group_get_min_gain(ma_sound_group* pGroup);
    [CLink] public static extern void ma_sound_group_set_max_gain(ma_sound_group* pGroup, float maxGain);
    [CLink] public static extern float ma_sound_group_get_max_gain(ma_sound_group* pGroup);
    [CLink] public static extern void ma_sound_group_set_min_distance(ma_sound_group* pGroup, float minDistance);
    [CLink] public static extern float ma_sound_group_get_min_distance(ma_sound_group* pGroup);
    [CLink] public static extern void ma_sound_group_set_max_distance(ma_sound_group* pGroup, float maxDistance);
    [CLink] public static extern float ma_sound_group_get_max_distance(ma_sound_group* pGroup);
    [CLink] public static extern void ma_sound_group_set_cone(ma_sound_group* pGroup, float innerAngleInRadians, float outerAngleInRadians, float outerGain);
    [CLink] public static extern void ma_sound_group_get_cone(ma_sound_group* pGroup, float* pInnerAngleInRadians, float* pOuterAngleInRadians, float* pOuterGain);
    [CLink] public static extern void ma_sound_group_set_doppler_factor(ma_sound_group* pGroup, float dopplerFactor);
    [CLink] public static extern float ma_sound_group_get_doppler_factor(ma_sound_group* pGroup);
    [CLink] public static extern void ma_sound_group_set_directional_attenuation_factor(ma_sound_group* pGroup, float directionalAttenuationFactor);
    [CLink] public static extern float ma_sound_group_get_directional_attenuation_factor(ma_sound_group* pGroup);
    [CLink] public static extern void ma_sound_group_set_fade_in_pcm_frames(ma_sound_group* pGroup, float volumeBeg, float volumeEnd, ma_uint64 fadeLengthInFrames);
    [CLink] public static extern void ma_sound_group_set_fade_in_milliseconds(ma_sound_group* pGroup, float volumeBeg, float volumeEnd, ma_uint64 fadeLengthInMilliseconds);
    [CLink] public static extern float ma_sound_group_get_current_fade_volume(ma_sound_group* pGroup);
    [CLink] public static extern void ma_sound_group_set_start_time_in_pcm_frames(ma_sound_group* pGroup, ma_uint64 absoluteGlobalTimeInFrames);
    [CLink] public static extern void ma_sound_group_set_start_time_in_milliseconds(ma_sound_group* pGroup, ma_uint64 absoluteGlobalTimeInMilliseconds);
    [CLink] public static extern void ma_sound_group_set_stop_time_in_pcm_frames(ma_sound_group* pGroup, ma_uint64 absoluteGlobalTimeInFrames);
    [CLink] public static extern void ma_sound_group_set_stop_time_in_milliseconds(ma_sound_group* pGroup, ma_uint64 absoluteGlobalTimeInMilliseconds);
    [CLink] public static extern ma_bool32 ma_sound_group_is_playing(ma_sound_group* pGroup);
    [CLink] public static extern ma_uint64 ma_sound_group_get_time_in_pcm_frames(ma_sound_group* pGroup);
#endif  /* MA_NO_ENGINE */
}